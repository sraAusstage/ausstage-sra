...
<%
  ...
  //System.out.println("Event Object:" + eventObj);
  //String eventId = request.getParameter("f_event_id");
  ...
  String notes        		= "";
  String childEventId  		= "";
  //System.out.println("Child Id:" + request.getParameter("f_child_event_id_"));
	...
	for(int i=0; i < eventEventLinks.size(); i++) {
	    EventEventLink eventEventLink = new EventEventLink(db_ausstage);
            // get data from the request object
     	    ...
     	    //System.out.println("Child Id:" +childEventId );
	    ...
	    //BW eventEventLinks.set(i, eventEventLink);
  ...
  if(error_msg.equals("")) {
		//eventObj.setEventEventLinks(eventEventLinks);
		//session.setAttribute("event", eventObj);
