...
<%
  ...
  if(Constants.LINK_TO_CUSTOM_MAIN_PAGE){
    if(Constants.CUSTOM_DISPLAY_NAME != null || !Constants.CUSTOM_DISPLAY_NAME.equals(""))
      ausstage_main_page_link += "<a href='" + Constants.ADMIN_DIRECTORY + "/" + Constants.LINK_TO_CUSTOM_MAIN_PAGE_NAME + "'><img border='0' src='" + Constants.IMAGE_DIRECTORY + "/custom_main_menu.gif' alt='Return to the " + Constants.CUSTOM_DISPLAY_NAME + " Main Menu'></a>";
    else
       ausstage_main_page_link += "<a href='" + Constants.ADMIN_DIRECTORY + "/" + Constants.LINK_TO_CUSTOM_MAIN_PAGE_NAME + "'><img border='0' src='" + Constants.IMAGE_DIRECTORY + "/custom_main_menu.gif' alt='Return to the Main Menu'></a>";
  }else{
    ausstage_main_page_link += "<a href='" + Constants.ADMIN_DIRECTORY + "/content_main_menu_custom.jsp'><img border='0' src='" + Constants.IMAGE_DIRECTORY + "/custom_main_menu.gif' alt='Return to the Custom Main Menu'></a>";
  }
