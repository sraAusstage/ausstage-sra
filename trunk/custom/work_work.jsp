...
<%
  ...
  Vector workWorkLinks = work.getAssociatedWorks();
  //System.out.println(workWorkLinks.toString());
//add the selected work to the work  
  if (f_select_this_work_id != null)
  {
    workWorkLinks.add(f_select_this_work_id);
  ...
  ***********************************************************/
  ...
  String temp_string    = "";       
  selectedWorks = work.getAssociatedWorks();
  ...
  for(int i = 0; i < selectedWorks.size(); i ++){
    //System.out.println("String:" +(selectedWorks.get(i)));
   // System.out.println("String:" +(selectedWorks.get(i)));
    try{
     temp_string  = work.getWorkInfoForDisplay(Integer.parseInt(((WorkWorkLink) selectedWorks.get(i)).getChildId()), stmt);
    }catch(Exception e){
