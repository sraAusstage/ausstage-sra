...
<%
  ...
  //System.out.println("Contrib Id:" + contrib_id);
  ...
  out.println("<input type='hidden' name='f_contrib_id' value='" + contrib_id + "'>");
  ...
  if (displayContribDetails) {
    if (!isPartOfThisEvent && request.getParameter("isReturn") == null && contrib_id != null &&
     !contrib_id.equals("") &&!contrib_id.equals ("0") && !action.equals("")) { // means we are editing contributor that is not part of the event that is stored in the session 
      contributor.load(Integer.parseInt(contrib_id));
      System.out.println("In edit");
      System.out.println((Integer.parseInt(contrib_id)));
    }
      ...
      System.out.println(request.getParameter("isReturn"));
    }
  ...
  %>
    <input class="line200" type="text" name="f_prefix" size="10" maxlength="40" value="<%=contrib_prefix%>">
  <%
    pageFormater.writeTwoColTableFooter (out); 
  ...
  %>
    ...
    <input class="line200" type="text" name="f_f_name" size="10" maxlength="40" value="<%=contrib_fname%>">
  <%
  ...
  %>
    <input class="line200" type="text" name="f_m_name" size="10" maxlength="40" value="<%=contrib_mname%>">
  <%
    pageFormater.writeTwoColTableFooter (out); 
    pageFormater.writeTwoColTableHeader (out, "Last Name *");
  %>
    <input class="line200" type="text" name="f_l_name" size="10" maxlength="40" value="<%=contrib_lname%>">
  <%
    pageFormater.writeTwoColTableFooter (out); 
    
    pageFormater.writeTwoColTableHeader (out, "Suffix");
  %>
    <input class="line200" type="text" name="f_suffix" size="10" maxlength="40" value="<%=contrib_suffix%>">
  <%
    pageFormater.writeTwoColTableFooter (out); 
    pageFormater.writeTwoColTableHeader (out, "Display Name");
  %>
    <input class="line200" type="text" name="f_display_name" size="10" maxlength="40" value="<%=contrib_display_name%>">
  <%
    pageFormater.writeTwoColTableFooter (out); 
  ...
  %>
    <input class="line50" type="text" name="f_contrib_day" size="10" maxlength="2" value="<%=contrib_dob_d%>">&nbsp;<input class="line50" type="text" name="f_contrib_month" size="10" maxlength="2" value="<%=contrib_dob_m%>">&nbsp;<input class="line50" type="text" name="f_contrib_year" size="10" maxlength="4" value="<%=contrib_dob_y%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    ...
    pob.load(Integer.parseInt((contributor.getPlaceOfBirth()!= null&&!contributor.getPlaceOfBirth().equals(""))?contributor.getPlaceOfBirth():"0"));
   // System.out.println("POB:" + pob.getName());
    out.println("<input type='text' name='f_place_of_birth_venue_name' readonly size='50' class='line300' value=\"" + pob.getName() + "\">");
    out.print("<td width=30><a style='cursor:hand' " + " onclick=\"Javascript:contrib_addedit_form.action='venue_search.jsp?mode=" + action + "&place_of_birth=1';" +
  ...
  %>
    <input class="line50" type="text" name="f_contrib_day_death" size="10" maxlength="2" value="<%=contrib_dod_d%>">&nbsp;<input class="line50" type="text" name="f_contrib_month_death" size="10" maxlength="2" value="<%=contrib_dod_m%>">&nbsp;<input class="line50" type="text" name="f_contrib_year_death" size="10" maxlength="4" value="<%=contrib_dod_y%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "");    
    out.println("dd&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mm&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;yyyy");
    ...
    //System.out.println("Value death:"+ contributor.getPlaceOfDeath());
    
    Venue pod = new Venue(db_ausstage);
    pod.load(Integer.parseInt((contributor.getPlaceOfDeath()!=null&&!contributor.getPlaceOfDeath().equals(""))?contributor.getPlaceOfDeath():"0"));
    //System.out.println("POD:" + pod.getName());    
    out.println("<input type='text' name='f_place_of_death_venue_name' readonly size='50' class='line300' value=\"" + pod.getName() + "\">");
    out.print("<td width=30><a style='cursor:hand' " + " onclick=\"Javascript:contrib_addedit_form.action='venue_search.jsp?mode=" + action + "&place_of_death=1';" +
              "contrib_addedit_form.submit();\"><img border='0' src='/custom/images/popup_button.gif'></a></td>");
    
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "Nationality");
  %>
    <input class="line200" type="text" name="f_contrib_nationality" size="10" maxlength="40" value="<%=contrib_nationality%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "Other Names");
  %>
    <input class="line200" type="text" name="f_contrib_other_names" size="10" maxlength="40" value="<%=contrib_other_names%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "Contributor Address");
  %>
    <input class="line200" type="text" name="f_contrib_address" size="10" maxlength="80" value="<%=contrib_address%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "Suburb");
  %>
    <input class="line200" type="text" name="f_contrib_town" size="10" maxlength="40" value="<%=contrib_town%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    //states
  ...
  %>
    <input class="line200" type="text" name="f_contrib_postcode" size="10" maxlength="4" value="<%=contrib_postcode%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "Email");
  %>
    <input class="line200" type="text" name="f_contrib_email" size="10" maxlength="40" value="<%=contrib_email%>">
  <%
    pageFormater.writeTwoColTableFooter (out);
    pageFormater.writeTwoColTableHeader (out, "Notes");
  %>
    <textarea name="f_contrib_notes" rows="6" cols="22"><%=contrib_notes%></textarea>
  <%
    pageFormater.writeTwoColTableFooter (out);
  ...
  <%
   ...
   out.println("<a name='contrib_org' />");
  ...
  ****************************/
  ...
  out.println("<a name='contrib_contrib_link' />");
...
<!--
  ...
  function checkFields(){
    ...
    if(msg != ""){
      ...
      document.f_contributor_addedit.delimited_contrib_funct_ids.value = temp_ids;
      return true;
    }
  }
-->
