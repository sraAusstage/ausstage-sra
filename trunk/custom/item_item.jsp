...
<%
  ...
  Vector childItemItemLinks = item.getAssociatedItems();
  ...
  if (f_unselect_this_child_id != null) {
    for(int i=0; i < childItemItemLinks.size(); i++) {
      ItemItemLink itemItemLink = (ItemItemLink)childItemItemLinks.elementAt(i);
      if (itemItemLink.getChildId().equals(f_unselect_this_child_id)) {
        childItemItemLinks.remove(i);
      }
    }
    item.setItemItemLinks(childItemItemLinks);   
  }
  ...
  list_db_sql = "SELECT  itemid childid,    citation  " +
