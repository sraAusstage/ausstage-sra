...
public class WebLinks
{
  ...
  */
  ...
  Parameters:
    p_id : id of the Web Links record
  ...
  */
  public void load(int p_id)
  {
    ...
    try
    {
      ...
      sqlString = "SELECT * FROM www WHERE " +
                  "www_id=" + p_id;
  ...
  Returns:
     ...
     new record in the m_web_links_id member.
  ...
  */
  public boolean add ()
  {
    try
    {
      ...
      {
        sqlString = "INSERT INTO www (collection_information_id, weblinks, web_description) VALUES (" +
                          m_collection_id                               + ",  " +
                    "'" + m_db.plSqlSafeString(m_web_links_name)        + "', " +
                    "'" + m_db.plSqlSafeString(m_web_links_description) + "'  " +
                    ")";
  ...
  */
  public boolean update ()
  {
    try
    {
      ...
      if (validateObjectForDB ())
      {
        sqlString = "UPDATE www set "   +
                    "weblinks='"        + m_db.plSqlSafeString(m_web_links_name) + "', " +
                    "web_description='" + m_db.plSqlSafeString(m_web_links_description) + "' " +
  ...
  */
  ...
  Purpose: Checks to see if the specified Web Link is in use in the database.

  Parameters:
    p_id : id of the record

  Returns:
     True if the web links record is in use, else false
  ...
  */
  ...
  Parameters:
    p_id : Unique ID of the Collection record.
  ...
  */
  ...
  public void   setWebLinksName        (String s) {m_web_links_name = s;}
  public void   setWebLinksDescription (String s) {m_web_links_description = s;}
  public void   setCollectionId        (String s) {m_collection_id = s;}

  public String getWebLinksName        () {return m_web_links_name;}
  public String getWebLinksDescription () {return m_web_links_description;}
  public String getCollectionId        () {return m_collection_id;}
  public String getError               () {return m_error_string;}

  public ausstage.Database getDatabase () {return m_db;}
}
