...
public class ContFunctPref
{
  ...
  */
  ...
  Purpose: Populates the object with the new
           contributor function information.

  Parameters:
    p_id : id of the Contributor Function Preferred record.
  ...
  */
  ...
  public void loadPreferredWithNonPreferredId(String p_id)
  {
    ...
    try
    {
      ...
      sqlString = "SELECT ContributorFunctPreferred.ContributorFunctPreferredId,  ContributorFunctPreferred.PreferredTerm " +
                  "FROM ContributorFunctPreferred, contfunct " +
                  "WHERE ContributorFunctPreferred.ContributorFunctPreferredId=contfunct.ContributorFunctPreferredId " + 
                  "AND contfunct.CONTFUNCTIONID=" + p_id;
      l_rs = m_db.runSQL (sqlString, stmt);
  ...
  */
  ...
  public void setPreferredId   (String s) {preferredId   = s;}
  public void setPreferredTerm (String s) {preferredTerm = s;}

  public String getPreferredId   () {if(preferredId == null) preferredId = ""; return preferredId;}
  public String getPreferredTerm () {if(preferredTerm == null) preferredTerm = ""; return preferredTerm;}
}
