...
public class ItemItemLink
{
  ...
  */
  public void load(String p_itemitemlink_id)
  {
    ...
    try
    {
      ...
      sqlString = " SELECT * FROM ItemItemLink, lookup_codes " +
  ...
  */
  ...
  Purpose: Modifies this object in the database by deleting all ItemItemLinks for this
  ...
  */
  public boolean update (String p_itemId, Vector p_childLinks)
  {
    try
    {
      ...
      sqlString = "DELETE FROM ItemItemLink where " +
                  "itemId=" + p_itemId;
      ...
      for (int i=0; p_childLinks != null && i < p_childLinks.size(); i++){
        ...
        sqlString = "INSERT INTO ItemItemLink "    +
                    "(itemId, childId, function_lov_id, notes) " +
                    "VALUES (" +
                    p_itemId + ", " + itemItemLink.getChildId() + ", " + itemItemLink.getFunctionId() + ", '" +
