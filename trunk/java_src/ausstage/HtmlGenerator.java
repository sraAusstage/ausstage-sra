...
public class HtmlGenerator
{
  ...
  */
  ...
  Parameters:
  p_request                - The request sent form the client
  p_title                  - The title of the page
  p_filter_display_names   - The display names of the fields that the data can be filtered by
  p_filter_names           - The names of the fields that the data can be filtered by
  p_order_display_names    - The display names of the fields that the data can be ordered by
  p_order_names            - The names of the fields that the data can be ordered by
  p_list_name              - The name of the selection field
  p_list_db_sql            - The sql that obtains the data to display from the database
  p_list_db_field_id_name  - The database field name that becomes the selection field
  p_list_db_display_fields - The database field names to display
  p_buttons_names          - Names to go on the buttons that relate to the Select Box
  p_buttons_actions        - Actions to associatewith the buttons that relate to the Select Box
  p_multiple               - Indicates if multiple selections are allowed
  p_max_results_displayed  - The maximum number of rows to display

  Returns:
     A string that is the search filter HTML
  */
  public String displaySearchFilter(HttpServletRequest p_request, String  p_title,
                                    Vector  p_filter_display_names,
                                    Vector  p_filter_names,
                                    Vector  p_order_display_names,
                                    Vector  p_order_names,
                                    String  p_list_name,
                                    String  p_list_db_sql,
                                    String  p_list_db_field_id_name,
                                    Vector  p_list_db_display_fields,
                                    Vector  p_buttons_names,
                                    Vector  p_buttons_actions,
                                    boolean p_multiple,
                                    int     p_max_results_displayed)
  {
    
    return displaySearchFilter(p_request, p_title,
                               p_filter_display_names,
                               p_filter_names,
                               p_order_display_names,
                               p_order_names,
                               p_list_name,
                               p_list_db_sql,
                               p_list_db_field_id_name,
                               p_list_db_display_fields,
                               p_buttons_names,
                               p_buttons_actions,
                               p_multiple,
                               p_max_results_displayed,
                               "");
  }
  ...
  p_multiple               - Indicates if multiple selections are allowed
  p_max_results_displayed  - The maximum number of rows to display
  p_additional_html        - Additional html can be added below the left column
  ...
  */
                                    ...
                                    String  p_additional_html)
  {
    ...
    try
    {
      ...
      Hashtable    hidden_fields = new Hashtable();  // Not used in this method
      CachedRowSet rset;
      int          counter       = 0;
      ...
      ret += "<form name='search_form' id='search_form' method='POST' action='" + ((String)p_request.getRequestURI()).substring(((String)p_request.getRequestURI()).lastIndexOf("/")+1);
      ...
      ret += searchFilterOrder (p_request.getParameter ("f_order_by"), p_order_names,
                                p_order_display_names);
      ...
      ret += searchFilterSelectBox (p_request, p_list_name, p_multiple, sqlString, p_max_results_displayed,
                                    p_list_db_field_id_name, p_list_db_display_fields,
  ...
  p_request                         - The request sent form the client
  p_title                           - The title of the page
  p_selected_box_title              - The title of the box of selected items
  p_filter_display_names            - The display names of the fields that the data can be filtered by
  p_filter_names                    - The names of the fields that the data can be filtered by
  p_order_display_names             - The display names of the fields that the data can be ordered by
  p_order_names                     - The names of the fields that the data can be ordered by
  ...
  p_list_db_field_id_name           - The database field name that becomes the selection field
  p_list_db_display_fields          - The database field names to display
  p_selected_list_name              - The name of the selection field in the selected list
  p_selected_list_db_sql            - The sql that obtains the data to display the selected list
  p_selected_list_db_field_id_name  - The database field name that becomes the selection field in the selected list
  p_selected_list_db_display_fields - The database field names to display in the selected list
  p_buttons_names                   - Names to go on the buttons that relate to the Select Box
  p_buttons_actions                 - Actions to associatewith the buttons that relate to the Select Box
  p_hidden_fields                   - Hashtable of fields and their values to make hidden;
  p_multiple                        - Indicates if multiple selections are allowed
  p_max_results_displayed           - The maximum number of rows to display
  p_additional_html                 - Additional html can be added below the left column
  
  Returns:
     A string that is the search filter and selection control HTML
  */
  public String displaySearchFilterAndSelector(HttpServletRequest p_request, String  p_title,
                                    String    p_selected_box_title,
                                    Vector    p_filter_display_names,
                                    Vector    p_filter_names,
                                    Vector    p_order_display_names,
                                    Vector    p_order_names,
                                    ...
                                    String    p_list_db_field_id_name,
                                    Vector    p_list_db_display_fields,
                                    String    p_selected_list_name,
                                    Vector    p_selected_records,
//                                    String    p_selected_list_db_sql,
                                    String    p_selected_list_db_field_id_name,
//                                    Vector    p_selected_list_db_display_fields,
                                    Vector    p_buttons_names,
                                    Vector    p_buttons_actions,
                                    Hashtable p_hidden_fields,
                                    boolean   p_multiple,
                                    int       p_max_results_displayed)
  {
    return (displaySearchFilterAndSelector(p_request,
                                           p_title,
                                           p_selected_box_title,
                                           p_filter_display_names,
                                           p_filter_names,
                                           p_order_display_names,
                                           p_order_names,
                                           ...
                                           p_list_db_field_id_name,
                                           p_list_db_display_fields,
                                           p_selected_list_name,
                                           p_selected_records,
                                           p_selected_list_db_field_id_name,
                                           p_buttons_names,
                                           p_buttons_actions,
                                           p_hidden_fields,
                                           p_multiple,
...
//                                    Vector    p_selected_list_db_display_fields,
                                    ...
                                    String    p_additional_html)
  {
    try
    {
      ...
      ret += searchFilterSelectBox (p_request, p_list_name, p_multiple, p_list_db_sql, p_max_results_displayed,
                                    p_list_db_field_id_name, p_list_db_display_fields,
                                    p_buttons_names, p_buttons_actions, stmt, m_db);
      ...
      ret += searchFilterSelectedItems (p_selected_box_title, p_selected_list_name,
                                        p_selected_records,
                                        p_selected_list_db_field_id_name,
//                                        p_selected_list_db_display_fields,
  ...
  Parameters:
    p_title         - The title of the form
    p_hidden_fields - Hashtable of fields and their values to make hidden;

  Returns:
     A HTML string that will display the initial part of the form.
  */
  ...
  Parameters:
    p_ordered_by          - Indicates which field the data is presently ordered by
    p_order_names         - The names of the fields that the data can be ordered by
    p_order_display_names - The display names of the fields that the data can be ordered by

  Returns:
     A HTML string that will display the Order By radio buttons.
  */
  
  private String searchFilterOrder (String ordered_by, Vector p_order_names,
                                    Vector p_order_display_names)
  {
    String ret = "";
    ...
    for (int i = 0; i < p_order_names.size(); i++)
    {
      if (ordered_by == null)
      {
        ordered_by = "";
        if (i == 0)
          ordered_by = p_order_names.elementAt(i).toString();
      }
          
      ret += "    <input type='radio' name='f_order_by' value='" + p_order_names.elementAt(i) + "'";
      if (ordered_by.equals (p_order_names.elementAt(i)))
        ret += " checked";
  ...
  Parameters:
    p_filter_names         - The names of the fields that the data can be filtered by
    p_filter_display_names - The display names of the fields that the data can be filtered by
    p_request              - The request sent from the client
    
  Returns:
     A HTML string that will display the Order By radio buttons.
  */
  
  private String searchFilterCriteria (Vector p_filter_names, Vector p_filter_display_names,
                                       HttpServletRequest p_request)
  {
    return searchFilterCriteria (p_filter_names,
                                 p_filter_display_names,
                                 p_request,
                                 "");
  }
  ...
  Parameters:
    ...
    p_filter_display_names - The display names of the fields that the data can be filtered by
    p_request              - The request sent from the client
    p_additional_html      - Any additional HTML that will appear unter the search criteria
  ...
  */
  ...
  private String searchFilterCriteria (Vector p_filter_names, Vector p_filter_display_names,
                                       HttpServletRequest p_request, String p_additional_html)
  {
    String ret = "";
  ...
  Parameters:
    p_list_name              - The name of the selection field
    p_multiple               - Indicates if multiple selections are allowed
    sqlString                - The sql that obtains the data to display from the database
    p_max_results_displayed  - The maximum number of rows to display
    p_list_db_field_id_name  - The database field name that becomes the selection field
    p_list_db_display_fields - The database field names to display
    p_buttons_names          - Names to go on the buttons that relate to the Select Box
    p_buttons_actions        - Actions to associatewith the buttons that relate to the Select Box
    stmt                     - The Statement that holds the connection to the database
    Database m_db            - The database handle
    
  Returns:
     A HTML string that will display the Select Box.
  */
  
  private String searchFilterSelectBox (HttpServletRequest p_request, String p_list_name, 
                                        boolean p_multiple, String sqlString, 
                                        int p_max_results_displayed,
                                        String p_list_db_field_id_name,
                                        Vector p_list_db_display_fields,
                                        Vector p_buttons_names,
    ...
    try
    {
      ...
      if (!sqlString.equals (""))
      {
        ...
        {          
          ...
          if(p_request.getRequestURI().substring(p_request.getRequestURI().lastIndexOf("/")+1).equals("event_contributors.jsp")){
            /**
              SPECIAL CASE: when the user is adding & editing contributor through
              addedit event facility, we need to display all the functions of each contibutor,
              ie name, lastname (function1, function2,...) within the selection box
            */
      ...
      for (int i = 0; i < p_buttons_names.size(); i++)
      {
        if(p_buttons_names.elementAt(i).toString().toLowerCase().equals("add")){
          if((f_id != null && !f_id.equals("")) || (sqlString.toLowerCase().indexOf("like") != -1)) // we performed a search so lets add the Add button
            ret += "    <input type='button' name='submit_type' value='" + p_buttons_names.elementAt(i) + "' onclick=\"" + p_buttons_actions.elementAt(i) + "\">&nbsp;\n";
        }
        else if ((p_buttons_names.elementAt(i).toString().toLowerCase().indexOf("edit") >= 0) || (p_buttons_names.elementAt(i).toString().toLowerCase().indexOf("view") >= 0)) {
          // For edit or preview/view buttons, parse the javascript to check that the user has selected an item first
          ...
          // Now add the check to ensure the user has selected something
          buttonAction = "if (document.getElementById('" + p_list_name + "').selectedIndex>=0) { " + buttonAction + " } else { alert('Please select an item to edit/view'); } ";
  ...
  Parameters:
    p_selected_box_title              - The title of the box of selected items
    p_selected_list_name              - The name of the selection field
    selected_sqlString                - The sql that obtains the data to display from the database
    p_selected_list_db_field_id_name  - The database field name that becomes the selection field
    p_selected_list_db_display_fields - The database field names to display
    stmt                              - The Statement that holds the connection to the database
    Database m_db                     - The database handle
    
  Returns:
     A HTML string that will display the list of selected items.
  */

  private String searchFilterSelectedItems (String p_selected_box_title,
  ...
  Parameters:
    ...
    p_helper_text             - text for header helper
    p_helper_number           - number displayed for helper header 
    p_form_action_url         - form action url
    p_hidden_field            - name & value pair for hidden fields
    p_item_name               - linked item name  
    p_object_vec              - storage vector for all the item objects
    p_max_results_displayed   - max limit of fields that can be displayed

  Returns:
     A string that is the linked items HTML
  */
  
  public String displayLinkedItem(String p_helper_text,
                                  String p_helper_number,
                                  String p_form_action_url, 
                                  String p_form_name,
                                  Hashtable p_hidden_field,
                                  String p_item_name,
                                  Vector p_object_vec,
                                  int p_max_results_displayed){
    return (displayLinkedItem(p_helper_text,
                              p_helper_number,
                              p_form_action_url, 
                              p_form_name,
                              p_hidden_field,
  ...
  Parameters:
    ...
    p_object_vec              - storage vector for all the item objects
    p_max_results_displayed   - max limit of fields that can be displayed
    p_additional_javascript   - Any additional javascript to execute on the button
  ...
  */
  ...
  public String displayLinkedItem(String p_helper_text,
                                  ...
                                  Vector p_object_vec,
                                  int p_max_results_displayed,
                                  String p_additional_javascript,
                                  boolean preview){
    ...
    try{
      ...
      ret += "        <td width='50'></td>\n";
      ret += "        <td width='410'>\n";
      //ret += "     <form name='linkedItemsForm_" + unique_form_id + "' id='linkedItemsForm_" + unique_form_id + "' method='post' action='" + p_form_action_url + "'>\n";
      ...
      ret += "              </tr>\n";
      ret += "              <tr>\n";
      ret += "                <td width='19' background='" + Constants.CUSTOM_IMAGE_DIRECTORY + "/join_vertical_line_left.gif' colspan='2'><img src='" + Constants.IMAGE_DIRECTORY + "/spacer.gif' border=0 width='19' height='16'></td>\n";
      ret += "                <td width='323' class='bodytext'>" + p_item_name + "</td>\n";
     // ret += "                <td width='66'><input type='button' name='select_btn' value='Select' onclick=\"document.event_addedit_form.action='" + p_form_action_url + "'; document.event_addedit_form.submit();\"></td>\n";
      if (preview==true)
        ret += "                <td width='66' align='right'></td>\n";
      else ret += "                <td width='66' align='right'><a style='cursor:hand' onclick=\"" + p_additional_javascript + "document." + p_form_name + ".action='" + p_form_action_url + "'; document." + p_form_name + ".submit();\"><img border='0' src='" + Constants.IMAGE_DIRECTORY + "/popup_button.gif'></a></td>\n";
      ret += "                <td width='2' background='" + Constants.CUSTOM_IMAGE_DIRECTORY + "/join_vertical_line_right.gif'><img src='" + Constants.IMAGE_DIRECTORY + "/spacer.gif' border=0 width='2' height='16'></td>\n";
      ret += "              </tr>\n";
      ret += "              <tr>\n";
...
//        ret += "            <table border='0' cellpadding='0' cellspacing='0' width='389'>\n";
        while(enuma.hasMoreElements()){
          ...
          if(object instanceof Datasource){
            ...
            ret += obj;
          }else{ //if(object instanceof Country){ // will cater for the two National Origin
