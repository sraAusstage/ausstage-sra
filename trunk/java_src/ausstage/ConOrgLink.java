...
public class ConOrgLink {
  ...
  */
  ...
  Parameters:
    p_contributorId : id of the Contributor record
  ...
  */
  public void load(String p_contributorId, String p_organisationId) {
    ...
    try {
      ...
      sqlString = " SELECT * FROM ConOrgLink " +
                  " WHERE organisationId = " + contributorId;
  ...
  Parameters:
    eventId
    String array of ConOrgLink records.
  ...
  */
  ...
  Purpose: Modifies this object in the database by deleting all ConOrgLinks for this
           Contributor and inserting new ones from an array of ConOrgLink records to link
           to this Contributor.
  ...
  public boolean update (String p_contributorId, Vector p_conOrgLinks)
  {
    try
    {
      ...
      for (int i=0; p_conOrgLinks != null && i < p_conOrgLinks.size(); i++){
        ...
        sqlString = "INSERT INTO ConOrgLink "    +
                    "(contributorId, organisationId, description) " +
                    "VALUES (" +
                    p_contributorId + ", " + conOrgLink.getOrganisationId() + ", '" + m_db.plSqlSafeString(conOrgLink.getDescription()) + "')";
  ...
  */
  ...
  Purpose: Returns a record set with all of the ConOrgLinks information in it.
  ...
  */
  public CachedRowSet getConOrgLinks(int p_contributorId)
  {
    ...
    try
    {
      ...
      sqlString = "SELECT * FROM ConOrgLink " +
                   "WHERE contributorId  = " + p_contributorId;
      l_rs = m_db.runSQL (sqlString, stmt);
      stmt.close();
      return (l_rs);
    }
  ...
  Purpose: Returns a Vector containing all the ConOrgLinks for this contributor.

  Parameters:
    Contributor Id

  Returns:
     A Vector of all ConOrgLinks for this contributor.
  */
  ...
  public void setContributorId   (String p_contributorId)  {contributorId  = p_contributorId;}
  public void setOrganisationId  (String p_organisationId) {organisationId = p_organisationId;}
  public void setDescription     (String p_description)    {description    = p_description;}

  public String              getContributorId   () {return (contributorId);}
  public String              getOrganisationId  () {return (organisationId);}
  public String              getDescription     () {if(description == null) description =""; return (description);}
