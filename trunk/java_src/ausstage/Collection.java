...
public class Collection
{
  ...
  */
  ...
  Parameters:
    p_id : id of the Collection record
  ...
  */
  public void load(int p_id)
  {
    ...
    try
    {
      ...
      sqlString = "SELECT * FROM collection_information WHERE " +
                  "collection_information_id=" + p_id;
  ...
  Returns:
     ...
     new record in the m_collection_information_id member.
  ...
  public boolean add ()
  {
    try
    {
      ...
      if (validateObjectForDB ())
      {
        ...
        if (m_description.length() >= 300)
          m_description = m_description.substring (0, 4000);
          
        // As the Comments is a text area, need to limit characters
        if (m_comments.length() > 4000)
          m_comments = m_comments.substring (0, 3999);
          
        // As the Related Sources is a text area, need to limit characters
        if (m_related_sources.length() > 4000)
          m_related_sources = m_related_sources.substring (0, 3999);

        sqlString = "INSERT INTO collection_information (ENTITY, DATE_ENTERED, " +
                    "INPUT_PERSON, COLLECTION_NAME, DESCRIPTION, COLLECTION_SIZE, " +
                    "LOCATION, COLLECTION_ACCESS, ACCESS_OTHER_DETAIL, " +
                    "RELATED_SOURCES, COMMENTS) VALUES ( " +
                                               m_entity               + " , " +
                    ...
                    "'" + m_db.plSqlSafeString(m_related_sources)     + "', " +
  ...
  */
  public boolean update ()
  {
    try
    {
      ...
      {
        // As the Description is a text area, need to limit characters
        if (m_description.length() > 4000)
          m_description = m_description.substring (0, 3999);
        ...
        m_date_updated = new Date();
        sqlString = "UPDATE collection_information set " +
                    "entity = "               + m_entity                                    + " , " +
                    "date_updated = "         + m_db.safeDateFormat(m_date_updated, false)  + ", " +
                    "collection_name = '"     + m_db.plSqlSafeString(m_collection_name)     + "', " +
                    "description = '"         + m_db.plSqlSafeString(m_description)         + "', " +
                    "collection_size = '"     + m_db.plSqlSafeString(m_size)                + "', " +
                    "location = '"            + m_db.plSqlSafeString(m_location)            + "', " +
                    "collection_access = "    + m_db.plSqlSafeString(m_access)              + " , " +
                    "access_other_detail = '" + m_db.plSqlSafeString(m_access_other_detail) + "', " +
                    "related_sources = '"     + m_db.plSqlSafeString(m_related_sources)     + "', " +
                    "comments = '"            + m_db.plSqlSafeString(m_comments)            + "'  " +
                    "where collection_information_id = " + m_collection_information_id;
        m_db.runSQL (sqlString, stmt);
        l_ret = true;
      }
      stmt.close ();
  ...
  */
  ...
  Purpose: Checks to see if the specified Collection is in use in the database.
  ...
  */
  public boolean checkInUse(int p_id)
  {
    ...
    {
      // WWW_Information
      // Not concerned about Web Links - when Collection is deleted, all Web Link records
      //     for the Connection will also be deleted.
      
      // MaterialLink
      // Not concerned about Materials - when Collection is deleted, all MaterialLink records
      //     for the Connection will also be deleted.
      return false;
    }
    catch (Exception e)
  ...
  */
  ...
  Purpose: Returns a record set with all of the collection information in it.
  ...
  */
  ...
  public CachedRowSet getCollectionsWithEntity(){
    ...
    try
    {
      ...
      sqlString = "SELECT collection_information.*, entity.name " +
                  "FROM collection_information, entity " +
                  "where entity.entity_id=collection_information.entity " +
  ...
  public void setCollectionInformationId (String s) {m_collection_information_id = s;}

  public void setEntity            (String s)    {m_entity              = s;}
  public void setDateEntered       (Date   d)    {m_date_entered        = d;}
  public void setDateUpdated       (Date   d)    {m_date_updated        = d;}
  public void setInputPerson       (String s)    {m_input_person        = s;}
  public void setCollectionName    (String s)    {m_collection_name     = s;}
  public void setDescription       (String s)    {m_description         = s;}
  public void setSize              (String s)    {m_size                = s;}
  public void setLocation          (String s)    {m_location            = s;}
  public void setAccess            (String s)    {m_access              = s;}
  public void setAccessOtherDetail (String s)    {m_access_other_detail = s;}
  public void setRelatedSources    (String s)    {m_related_sources     = s;}
  public void setComments          (String s)    {m_comments            = s;}
  public void setMaterials         (String [] s) {m_materials           = s;}

  public String getCollectionInformationId () {return m_collection_information_id;}

  public String getEntity            () {return m_entity;}
  public Date   getDateEntered       () {return m_date_entered;}
  public Date   getDateUpdated       () {return m_date_updated;}
  public String getInputPerson       () {return m_input_person;}
  public String getCollectionName    () {return m_collection_name;}
  ...
  public String getAccessOtherDetail () {return m_access_other_detail;}
  public String getRelatedSources    () {return m_related_sources;}
  public String getComments          () {return m_comments;}
  public String [] getMaterialsArray () {return m_materials;}
