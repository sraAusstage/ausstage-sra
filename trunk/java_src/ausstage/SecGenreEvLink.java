...
public class SecGenreEvLink
{
  ...
  */
  ...
  Purpose: Sets the class to a contain the SecGenreEvLink information for the
           specified Secondary Genre id.

  Parameters:
    p_id : id of the Secondary Genrerecord
  ...
  */
  public void load(String p_id, String e_id)
  {
    ...
    try
    {
      ...
      sqlString = "SELECT * FROM secgenreclasslink " +
  ...
  Parameters:
    ...
    String array of Secondary Genre EvLink records.
  ...
  */
  ...
  Purpose: Modifies this object in the database by deleting all SecGenreEvLink for this
           Event and inserting new ones from an array of Secondary Genre  records to link
           to this Event.

  Parameters:
    Event Id
    String array of Secondary Genre Link records.
  ...
  */
  public boolean update (String eventId, Vector secondaryGenreEvLinks)
  {
    try 
    {
      ...
      sqlString = "DELETE FROM secgenreclasslink where " +
                  "eventId=" + eventId;
      ...
      for (int i=0; secondaryGenreEvLinks != null && i < secondaryGenreEvLinks.size(); i++)
      {
        ...
        sqlString = "INSERT INTO secgenreclasslink "    +
                    "(secGenrePreferredId, eventId) VALUES (" +
                    evLink.getSecGenrePreferredId() + ", "    + eventId + ")";
        m_db.runSQL (sqlString, stmt);
      }
      l_ret = true;
  ...
  */
  ...
  Purpose: Returns a record set with all of the SecondaryGenreEvLinks information in it.
  ...
  */
  ...
  Purpose: Returns a Vector containing all the SecondaryGenreEvLinks for this Event.

  Parameters:
    Event Id

  Returns:
     A Vector of all SecondaryGenreEvLinks for this Event.
  */
  ...
  public void setSecGenrePreferredId (String s)            {secGenrePreferredId = s;}
  public void setEventId                (String s)            {eventId                = s;}
  public void setSecondaryGenre      (SecondaryGenre p) {secondaryGenre      = p;}

  public String            getSecGenrePreferredId () {return (secGenrePreferredId);}
  public String            getEventId                () {return (eventId);}
  public SecondaryGenre getSecondaryGenre      () {return (secondaryGenre);}
