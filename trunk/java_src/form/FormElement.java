...
public class FormElement
{
    ...
    public FormElement(String type_name, String display_name, String table_location_row, String table_location_col, String size_length, String html_name, String do_validate, 
            String default_val, String default_display_val, String num_rows, String num_cols, String group_id, String is_selected, String element_id, 
            String is_multiselect, String field_type)
    {
        ...
        setElementProperties(type_name, display_name, table_location_row, table_location_col, size_length, html_name, do_validate, default_val, default_display_val, num_rows, num_cols, group_id, is_selected, element_id, is_multiselect, field_type);
    }
...
"h,html_name , do_validate,num_rows,num_cols ,form_element_group_id , is_selected" +
",is_multiselect, field_type from form_element where form_element_id="
 + element_id;
            ...
            if(rset.next())
            {
                ...
                setElementProperties(rset.getString("type_name"), rset.getString("display_name"), rset.getString("table_location_row"), rset.getString("table_location_col"), rset.getString("size_length"), rset.getString("html_name"), rset.getString("do_validate"), from_clob_default_val, from_clob_default_display_val, rset.getString("num_rows"), rset.getString("num_cols"), rset.getString("form_element_group_id"), rset.getString("is_selected"), element_id, rset.getString("is_multiselect"), rset.getString("field_type"));
            }
        }
        catch(Exception e)
        {
    ...
    private void setElementProperties(String type_name, String display_name, String table_location_row, String table_location_col, String size_length, String html_name, String do_validate, 
            String default_val, String default_display_val, String num_rows, String num_cols, String group_id, String is_selected, String element_id, 
            String is_multiselect, String field_type)
    {
