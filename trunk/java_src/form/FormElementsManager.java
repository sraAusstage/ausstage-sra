...
"_selected,is_multiselect,field_type from form_element where form_layout_id="
 + form_layout_id + " order by table_location_row";
                    rset = db.runSQL(sqlString, stmt);
                    rset.next();
                    do
                    {
                        ...
                        FormElement formElement = new FormElement(type_name, display_name, table_location_row, table_location_col, size_length, html_name, do_validate, default_val, default_display_val, num_rows, num_cols, group_id, is_selected, element_id, is_multiselect, field_type);
...
"!!"
    ...
    public String getOccupiersID(Database db, String rowLocation, String colLocation, String form_layout_id)
    {
        ...
        {
            Statement stmt = db.m_conn.createStatement();
            sqlString = "select table_location_row, table_location_col, form_element_id from form_element" +
" where table_location_row="
 + rowLocation + " and " + "table_location_col= " + colLocation + " and form_layout_id=" + form_layout_id;
            rset = db.runSQL(sqlString, stmt);
            if(rset.next())
            {
        ...
        {
            System.out.println("Finding out if the table cell is occupied by a form element - We have an excepti" +
"on!!!"
);
            System.out.println("MESSAGE: " + e.getMessage());
            System.out.println("LOCALIZED MESSAGE: " + e.getLocalizedMessage());
    ...
    public boolean insertFormElement(String type_name, String html_name, String display_name, String table_location_row, String table_location_col, String size_length, String do_validate, 
            String default_val, String default_display_val, String num_rows, String num_cols, String element_group_id, String is_selected, String form_layout_id, 
...
"_group_id, is_selected, form_layout_id, is_multiselect, field_type) values ('"
 + type_name + "','" + html_name + "','" + db.plSqlSafeString(display_name) + "','" + table_location_row + "','" + table_location_col + "','" + size_length + "','" + do_validate + "','" + num_rows + "','" + num_cols + "','" + element_group_id + "','" + is_selected + "','" + form_layout_id + "','" + is_multiselect + "','" + field_type + "')";
        try
        {
            db.runSQL(sqlString, stmt);
            ...
            try
            {
                ...
                {
                    sqlString = "update form_element set default_val='" + db.plSqlSafeString(default_val) + "', default_display_val='" + db.plSqlSafeString(default_display_val) + "' where form_element_id=" + new_form_element_id;
                    db.runSQL(sqlString, stmt);
                }
            }
            catch(Exception e)
...
"nt table - We have an exception!!!"
    ...
    public boolean updateFormElement(String form_element_id, String type_name, String html_name, String display_name, String table_location_row, String table_location_col, String size_length, 
    ...
    {
        boolean retVal = true;
        sqlString = "update form_element set type_name='" + type_name + "',html_name='" + db.plSqlSafeString(html_name) + "', display_name='" + db.plSqlSafeString(display_name) + "', table_location_row='" + table_location_row + "', table_location_col='" + table_location_col + "', size_length='" + size_length + "', do_validate='" + do_validate + "', num_rows='" + num_rows + "', num_cols='" + num_cols + "', form_element_group_id='" + element_group_id + "', is_selected='" + is_selected + "', is_multiselect= '" + is_multiselect + "', field_type='" + field_type + "' where form_element_id=" + form_element_id;
        try
        {
            db.runSQL(sqlString, stmt);
            try
            {
                ...
                {
                    sqlString = "update form_element set default_val='" + db.plSqlSafeString(default_val) + "', default_display_val='" + db.plSqlSafeString(default_display_val) + "' where form_element_id=" + form_element_id;
                    db.runSQL(sqlString, stmt);
                }
            }
            catch(Exception e)
            {
                System.out.println("Trying to update the default_val & default_display_val in\nthe form_element tabl" +
"e - We have an exception!!!"
);
                throw e;
            }
        }
    ...
    public boolean deleteFormElement(String form_element_id, String element_type, String form_layout_id, Statement stmt, Database db)
    {
        ...
        {
            sqlString = "select form_element_id from form_element where not form_element_id=" + form_element_id + " and form_element_group_id=" + form_element_group_id + " and not type_name='label' and form_layout_id=" + form_layout_id;
            try
            {
                rset = db.runSQL(sqlString, stmt);
                if(!rset.next())
...
"t null and (type_name='radiobutton' or type_name='checkbox') and form_layout_id="
 + form_layout_id;
        try
        {
            Statement stmt = db.m_conn.createStatement();
    ...
    private boolean hasLabel(String form_element_group_id, Database db)
        throws Exception
    {
        boolean retBool = false;
