...
public class ValidateLogin
{
    ...
    public boolean checkPermission(boolean p_sval1, boolean p_sval2, boolean p_sval3, boolean p_sval4, boolean p_sval5, boolean p_sval6, int p_f1, 
            int p_f2, int p_f3, int p_f4, int p_f5, int p_f6)
    {
        if(!p_sval1 && p_f1 != 0)
        {
            return true;
...
/*    private boolean checkLDAP(int checkType, String p_username, String p_password, Database p_db)
    {
        ...
        if(checkType == VALIDATE)
        {
            ...
            System.out.println("ValidateLogin.login - before call");
        ...
        System.out.println("ValidateLogin.createUserRecordsIfRequired - after call");
        if(success)
        {
            success = checkAuthors(EXIST, p_username, p_password, p_db);
        }
        return success;
    }*/
