...
public void displayUpdateForm(String                p_id,
  ...
  try {
    ...
    p_out.println("  <tr><td align='right' >Comment on this record&nbsp;&nbsp;&nbsp;<a style=\"cursor:pointer\" onclick=\"javascript:toggleUpdateForm();\"><img id=\"UpdateFormImg\" border=\"0\" src='../resources/images/add.gif'></a></td></tr>");
    p_out.println("<tr><td></td></tr>");
    p_out.println("<tr><td style='text-align:right; padding-right:153px;'><a href='#' align='right' onclick='window.print();return false;'>Print</a></td></tr>");
    p_out.println("<tr><td style='text-align:right; padding-right:90px;'><a href='csv.jsp?f_contrib_id=" + p_request.getParameter("f_contrib_id") + "' align='right' >Export to excel</a></td></tr>");
    p_out.println("</table>");
...
String org_id               = request.getParameter("f_org_id");
String contrib_id           = request.getParameter("f_contrib_id");
String articleId            = request.getParameter("f_articleId");
String item_id              = request.getParameter("f_item_cat_id");
String work_id							= request.getParameter("f_work_id");
String contentindicatorid   = request.getParameter("f_contentindicator_id");
...
Vector item_contentindlinks;
  ...
  if(contrib_id != null){
    ...
    out.println("     <td align='right' width ='25%'  class='general_heading_light' valign='top'>Contributor Name</td>");
    out.println("     <td>&nbsp;</td>");
    ...
    if(contributor.getGender() != null && !contributor.getGender().equals("")) {
	    out.println("   <tr bgcolor='#eeeeee'>");
	    out.println("     <td  align='right' class='general_heading_light' valign='top'>Gender</td>");
	    out.println("     <td>&nbsp;</td>");
    ...
    if(contributor.getNationality() != null && !contributor.getNationality().equals("")) {
	    out.println("   <tr>");
	    out.println("     <td align='right' class='general_heading_light' valign='top'>Nationality</td>");
	    out.println("     <td>&nbsp;</td>");
    ...
    { 
      if(hasValue(contributor.getDobYear()))
      {
	      //Date of Birth  
	      out.println("   <tr bgcolor='#eeeeee'>");
	      out.println("     <td align='right' class='general_heading_light' valign='top'>Date of Birth</td>");
	      out.println("     <td>&nbsp;</td>");
	      out.println("     <td >");
      ...
      if(hasValue(contributor.getDodYear()))  
      {
    	...
    	//Date of death
	      out.println("   <tr bgcolor='#eeeeee'>");
	      out.println("     <td align='right' class='general_heading_light' valign='top'>Date of Death</td>");
	      out.println("     <td>&nbsp;</td>");
	      out.println("     <td >");
    ...
    */
    ...
    //Functions
    out.println("   <tr>");
    out.println("     <td align='right' class='general_heading_light' valign='top'>Functions</td>");
    out.println("     <td>&nbsp;</td>");
    ...
    if(contributor.getNotes() != null && !contributor.getNotes().equals("")) {
	    out.println("   <tr bgcolor='#eeeeee'>");
	    out.println("     <td align='right' class='general_heading_light' valign='top'>Notes</td>");
	    out.println("     <td>&nbsp;</td>");
...
if(crset.next()){
  ...
  do{      
    ...
    out.print("<li><a href=\"indexdrilldown.jsp?f_event_id=" +
...
out.println("   </td></tr>"); 
    ...
    "SELECT DISTINCT events.eventid,events.event_name,events.ddfirst_date,events.mmfirst_date,events.yyyyfirst_date, "+
  	"events.first_date,venue.venue_name,venue.suburb,states.state,organisation.name,evcount.num "+
     	 ...
     	 do{
     		...
     		eventorgcount++;
     		 if (!prevOrg.equals(eo_rs.getString("name"))) {
  	        	...
  	        	out.print(eo_rs.getString("name")+ "<br><ul>");
...
//Works
    ...
    if(rset != null)
    {
      while(rset.next())
      {
    	  if(rowCount == 0)
    	  {
    		  out.println("     <td align='right' class='general_heading_light' valign='top'><a href=\"#\" onclick=\"showHide('works')\">Related Works</a></td>");
    			out.println("     <td>&nbsp;</td>");
    			out.println("     <td >");
    	   		  out.println("       <table id='works' width=\"" + secTableWdth + "\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\">");
    			rowCount++;
    		}    			   	  
   		out.println("<tr><td width=\"" + secCol1Wdth + "\"  valign=\"top\"><a href=\"indexdrilldown.jsp?f_work_id=" +
    ...
    if(rset != null)
    {
      while(rset.next())
      {
    	  if(Counter == 0)
    	  {
    	    out.println("     <td align='right' class='general_heading_light' valign='top'><a href=\"#\" onclick=\"showHide('resources')\">Related Resources</a></td>");
    	    out.println("     <td>&nbsp;</td>");
    	    out.println("     <td >");
    	    out.println("       <table id='resources' width=\"" + secTableWdth + "\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\">");
    	    Counter++;
    	  }
    	   out.println("<tr><td  valign=\"top\"><a href=\"indexdrilldown.jsp?f_item_cat_id=" +
    ...
    //Contributor ID
    out.println("   <tr bgcolor='#eeeeee'>");
    out.println("     <td align='right' class='general_heading_light' valign='top'>Contributor Identifier</td>");
