...
<head>
  ...
  <!-- libraries --> 
  <script type="text/javascript" src="/pages/assets/javascript/libraries/protovis-r3.2.js"></script>
  ...
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.form-2.4.3.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.validate-1.7.min.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.selectboxes-2.2.4.min.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.tipsy-1.0.0a.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.scrollTo-min.js"></script>	
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.multiselect.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.multiselect.filter.js"></script>	
  <script type="text/javascript" src="/pages/assets/javascript/libraries/exclusivecheck.jquery.min.js"></script>	
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.jsonp-2.1.4.min.js"></script>			
  <script type="text/javascript" src="/pages/assets/javascript/libraries/jquery.icolor.js"></script>		
  ...
  <!-- custom code -->
  <script type="text/javascript" src="/pages/assets/javascript/networks.js"></script>	
  <script type="text/javascript" src="/pages/assets/javascript/ncommon.js"></script>		
  <script type="text/javascript" src="/pages/assets/javascript/nsearch.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/viewerControl.js"></script>		
  <script type="text/javascript" src="/pages/assets/javascript/eventViewer.js"></script>		
  <script type="text/javascript" src="/pages/assets/javascript/contributorViewer.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/ntimeline.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/slider.js"></script>
  <script type="text/javascript" src="/pages/assets/javascript/navigation.js"></script>					    
...
<body>
  <span id="ruler"></span>
  <div class="wrapper"> 
    <div class="header b-187">
      <a href="/pages/search/"><img src="/resources/images/ausstagehomebrand.gif" alt="default" border="0" id="headerLogo"></a>
      <h1>Researching live performance in Australia</h1>
    </div>
    
    <div id="loginBar" class="b-186" style="padding-top:2px">  
	...
	<div class="peekaboo-tohide">	
	  <ul>
	    <li><a href="/pages/search/" title="Search">Search</a></li>
	    <li><a href="/pages/network/" title="Networks">Navigating Networks</a> </li>			
	...
	<div class="legendContainer">
	  <div id="viewer_options_div">
		...
		<div><input type="checkbox" name="showAllFaceted" class="checkbox" checked />
		  <label for="showAllFaceted">Show all nodes</label>
		</div>
