...
%><%
  ...
  //Secondary Genre
  out.println("\"Secondary Genre Name\",\"" + secondaryGenre.getName() + "\"");
  
  //Secondary Genre identifer
  out.println("");
  out.println("\"Secondary Genre Identifier\",\"" + secondaryGenre.getId() + "\"");
  ...
  if(rset != null){
    out.println("\"Events\"");
    while(rset.next()){
      out.print("\"" + (rset.getString("event_name")==null?"":rset.getString("event_name")) +"\",");
      out.print("\"" + (rset.getString("venue_name")==null?"":rset.getString("venue_name")) +"\",");
      out.print("\"" + (rset.getString("suburb")==null?"":rset.getString("suburb"))+"\",");
      out.print("\"" + (rset.getString("state")==null?"":rset.getString("state"))+"\",");
