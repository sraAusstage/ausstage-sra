...
public void displayUpdateForm(String                p_id,
  ...
  try {
    ...
    p_out.println("<tr><td style='text-align:right; padding-right:90px;'><a href='csv.jsp?id=" + p_request.getParameter("id") + "' align='right' >Export to excel</a></td></tr>");
    p_out.println("</table>");
