...
<%
		...
		ORGANISATION RESULT
		**********************************************/
		System.out.println("ORGANISATION SEARCH ");      
		...
		if(search_within_search_for_result.equals(""))
			...
			<thead>          
				...
				<th width='10%' align='right'><b><a href='#' onClick='reSortData("num")'>Events</b></a></th>
				<th width='10%' align='right'><b><a href='#' onClick='reSortData("total")'>Resources</b></a></th>
				</tr>
			</thead>
			...
			do{
				if(page_num == null){
					...
					<td <%=bgcolour%> align="left" valign="top" ><%=crset.getString("dates")%></td>          
