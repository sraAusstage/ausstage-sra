...
<%
  ...
  admin.Common Common = new admin.Common();  
	  ...
	  if (displayUpdateForm) {
	      displayUpdateForm(contentindicatorid, "ContentIndicator", contentIndicator.getName(),
	                        out,
	                        request,
	  ...
	  if (groupNames.contains("Administrators") || groupNames.contains("Content Indicator Editor"))
		...
		int rowCIItemCount=0;
		  ...
		  out.println("     <table align=\"center\" width='98%' border=\"0\" cellpadding=\"3\" cellspacing=\"0\">");
		    ...
		    //Content Indicator
		    out.println("  <tr>");
		    out.println("    <td width = '25%' align='right'  class='general_heading_light f-186' valign='top'>Subject</td>");
		    out.println("     <td>&nbsp;</td>");
		    out.println("     <td width ='75%' ><b>" + contentIndicator.getName() + "</b></td>");
		    out.println("   </tr>");
	     ...
	     out.println("   <tr class=\"b-185\">");
		  ...
		  //CI identifer
		    ...
		    out.println("   <tr>");
		    out.println("     <td align='right'  class='general_heading_light f-186' valign='top'>Subject Identifier</td>");
		    out.println("     <td>&nbsp;</td>");
		    out.println("     <td >" + contentIndicator.getId() + "</td>");
		    out.println("   </tr>");
