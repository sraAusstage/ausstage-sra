...
%><%
  ...
  //Name
   out.println("\"Function Name\",\"" + function.getPreferredTerm() + "\"");
    
  //Contributor Function Identifier
  out.println("");
   out.println("\"Contributor Function Identifier\",\"" + function.getPreferredId() + "\"");
  ...
  if(rset != null)
  {
	...
	out.println("\"" + rset.getString("name").replaceAll("\\\"", "\\\"\\\"") + "\"");
    }
  } 
  // close statement
  stmt.close();
