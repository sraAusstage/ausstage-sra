...
public class Reports
{
    ...
    public String addLog(String p_browser_ip, String p_page_id, HttpSession p_session)
    {
        ...
        try
        {
            ...
            sqlString = "insert into reportings (browser_ip,page_id,repo_date) values (" + convertIpToDecimal(p_browser_ip) + ", to_date('" + currentYear + "-" + currentMonth + "-" + currentDay + "', 'yyyy-mm-dd'), " + p_page_id + ",)";
