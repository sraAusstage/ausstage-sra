...
public class DescriptionSource
{
  ...
  */
  ...
  Parameters:
    p_id : id of the description source record

  Returns:
     The description source description.
  ...
  */
  public String getDescriptionSource(int p_id)
  {
    ...
    {      
      ...
      sqlString = "SELECT * FROM DESCRIPTIONSRC WHERE " +
                  "descriptionsourceid=" + p_id;
      l_rs = m_db.runSQL (sqlString, stmt);
        
      if (l_rs.next())
        l_ret = l_rs.getString ("descriptionsource");
      l_rs.close();
      stmt.close();
      return (l_ret);
    }
  ...
  Purpose: Returns a record set with all of the description source information in it.
