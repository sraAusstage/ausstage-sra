  ...
  */
  public void load(String p_ITEMCONLINKID , String p_creator_flag)
  {
    ...
    try
    {
      ...
      sqlString = " SELECT * FROM ITEMCONLINK" +
                  " WHERE ITEMCONLINKID = " + p_ITEMCONLINKID +
  ...
  */
  public boolean update (String p_itemId, Vector p_contribLinks, String p_creator_flag)
  {
    try
    {
      ...
      sqlString = "DELETE FROM ITEMCONLINK where " +
                  "itemId=" + p_itemId +
                  " AND ((creator_flag is NULL and '" + p_creator_flag + "'='N') or creator_flag='" + p_creator_flag + "')";
      ...
      for (int i=0; p_contribLinks != null && i < p_contribLinks.size(); i++){
        ...
        sqlString = "INSERT INTO ITEMCONLINK "    +
                    "(itemId, CONTRIBUTORID,creator_flag, orderBy, function_lov_id) " +
                    "VALUES (" +
                    p_itemId + ", " + itemContribLink.getContribId() + ",'" + p_creator_flag + "'," + itemContribLink.getOrderBy() + ", " + functionId + ")";
        m_db.runSQL (sqlString, stmt);
      }
      l_ret = true;
  ...
  public void setFunctionId      (String s) {functionId = s;}
