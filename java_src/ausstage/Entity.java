...
public class Entity
{
  ...
  */
  ...
  Returns:
     ...
     new record in the m_entity_id member.
  ...
  public boolean add ()
  {
    try
    {
      ...
      if (validateObjectForDB ())
      {
        ...
        sqlString = "INSERT INTO ENTITY (TYPE, DATE_ENTERED, INPUT_PERSON, NAME, ADDRESS, "      +
                    "CITY_SUBURB, STATEID, POSTCODE, CONTACTS, PHONE, FAX, EMAIL, WWW) VALUES (" +
                    "    " + m_type                                 +
  ...
  */
  public boolean update ()
  {
    try
    {
      ...
      if (validateObjectForDB ())
      {
        sqlString = "UPDATE ENTITY set " +
                    "TYPE= "         + m_type                                 + " , " +
                    "DATE_UPDATED="  + m_db.safeDateFormat(new Date(), false) + ", " +
                    "NAME='"         + m_db.plSqlSafeString(m_name)           + "', " +
                    "ADDRESS='"      + m_db.plSqlSafeString(m_address)        + "', " +
                    "CITY_SUBURB='"  + m_db.plSqlSafeString(m_city_suburb)    + "', " +
                    "STATEID="       + Integer.parseInt(m_stateid)            + ", "  +
                    "POSTCODE='"     + m_db.plSqlSafeString(m_postcode)       + "', " +
                    "PHONE='"        + m_db.plSqlSafeString(m_phone)          + "', " +
                    "FAX='"          + m_db.plSqlSafeString(m_fax)            + "', " +
                    "EMAIL='"        + m_db.plSqlSafeString(m_email)          + "', " +
                    "WWW='"          + m_db.plSqlSafeString(m_www)            +  "' " +
  ...
  */
  ...
  Returns:
     True if the entity is in use, else false
  ...
  */
  ...
  public void setAddress     (String s) {m_address      = s;}
  public void setCitySuburb  (String s) {m_city_suburb  = s;}
  public void setStateid     (String s) {m_stateid      = s;}
  public void setContacts    (String s) {m_contacts     = s;}
  public void setPostcode    (String s) {m_postcode     = s;}
  public void setPhone       (String s) {m_phone        = s;}
  public void setFax         (String s) {m_fax          = s;}
  public void setEmail       (String s) {m_email        = s;}
  public void setWWW         (String s) {m_www          = s;}

  public int    getEntityId    () {return (m_entity_id);}
  public String getInputPerson () {return (m_input_person);}
  public String getType        () {return (m_type);}
  public String getName        () {return (m_name);}
  public String getAddress     () {return (m_address);}
  public String getCitySuburb  () {return (m_city_suburb);}
  public String getStateid     () {return (m_stateid);}
  public String getPostcode    () {return (m_postcode);}
  public String getContacts    () {return (m_contacts);}
