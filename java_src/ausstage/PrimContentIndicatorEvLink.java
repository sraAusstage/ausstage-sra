...
public class PrimContentIndicatorEvLink
{
  ...
  */
  ...
  Purpose: Sets the class to a contain the PrimContentIndicatorEvLink information for the
  ...
  */
  public void load(String p_id, String e_id)
  {
    ...
    try
    {
      ...
      sqlString = " SELECT * FROM PrimContentIndicatorEvLink" +
                  " WHERE primContentIndicatorId = " + p_id +
                  " AND   eventId                = " + e_id;
  ...
  Parameters:
    ...
    String array of Primary Content Indicator EvLink records.
  ...
  */
  ...
  Purpose: Modifies this object in the database by deleting all PrimContentIndicatorEvLinks for this
           Event and inserting new ones from an array of Primary Content Indicator records to link
           to this Event.

  Parameters:
    Event Id
    String array of Primary Content Indicator Link records.
  ...
  */
  public boolean update (String eventId, Vector primContentIndicatorEvLinks)
  {
    try
    {
      ...
      sqlString = "DELETE FROM PrimContentIndicatorEvLink where " +
                  "eventId=" + eventId;
      ...
      for (int i=0; primContentIndicatorEvLinks != null && i < primContentIndicatorEvLinks.size(); i++)
      {
        ...
        sqlString = "INSERT INTO PrimContentIndicatorEvLink "    +
                    "(primContentIndicatorId, eventId) VALUES (" +
                    evLink.getPrimContentIndicatorId() + ", "    + eventId + ")";
        m_db.runSQL (sqlString, stmt);
      }
      l_ret = true;
  ...
  Purpose: Deletes all PrimContentIndicatorEvLink records for the specified Event Id.
  ...
  */
  ...
  Purpose: Returns a record set with all of the PrimContentIndicatorEvLinks information in it.
  ...
  */
  ...
  Purpose: Returns a Vector containing all the PrimContentIndicatorEvLinks for this Event.

  Parameters:
    Event Id

  Returns:
     A Vector of all PrimContentIndicatorEvLinks for this Event.
  */
  ...
  public void setPrimContentIndicatorId (String s)            {primContentIndicatorId = s;}
  public void setEventId                (String s)            {eventId                = s;}
  public void setPrimaryContentInd      (PrimaryContentInd p) {primaryContentInd      = p;}

  public String            getPrimContentIndicatorId () {return (primContentIndicatorId);}
  public String            getEventId                () {return (eventId);}
  public PrimaryContentInd getPrimaryContentInd      () {return (primaryContentInd);}
