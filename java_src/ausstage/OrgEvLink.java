...
public class OrgEvLink
{
  ...
  */
  public void load(String p_id, String e_id)
  {
    ...
    try
    {
      ...
      "From orgfunctmenu"+
      " INNER JOIN orgevlink ON (orgfunctmenu.orgfunctionid = orgevlink.`function`)"+
      " INNER JOIN contributorfunctpreferred ON (orgevlink.artistic_function = contributorfunctpreferred.contributorfunctpreferredid)"+
                  " WHERE organisationId = " + p_id +
                  " AND   eventId        = " + e_id +
                  " AND   `function`       = OrgFunctionId ";
  ...
  Parameters:
    eventId
    String array of OrgEvLink records.
  ...
  */
  ...
  Purpose: Modifies this object in the database by deleting all OrgEvLinks for this
           Event and inserting new ones from an array of OrgEvLink records to link
           to this Event.
  ...
  */
  public boolean update (String eventId, Vector orgEvLinks)
  {
    try
    {
      ...
      sqlString = "DELETE FROM OrgEvLink where " +
                  "eventId=" + eventId;
      ...
      for (int i=0; orgEvLinks != null && i < orgEvLinks.size(); i++)
      {
        ...
        if (l_function != null && l_function.equals ("0"))
          l_function = null;
          
        if (l_artisticFunction != null && l_artisticFunction.equals ("0"))
          l_artisticFunction = null;
          
        sqlString = "INSERT INTO OrgEvLink "    +
                    "(eventId, organisationId, function, artistic_function) " +
                    "VALUES (" +
                    eventId + ", " + orgEvLink.getOrganisationId() + ", " + l_function + ", " +
                    l_artisticFunction + ")";
        m_db.runSQL (sqlString, stmt);
  ...
  */
  ...
  Purpose: Returns a record set with all of the OrgEvLinks information in it.
  ...
  */
  public CachedRowSet getOrgEvLinks(int eventId)
  {
    ...
    try
    {
      ...
      sqlString =  " SELECT orgevlink.orgevlinkid,orgevlink.eventid,orgevlink.organisationid,orgevlink.`function`," +
      		...
      		"contributorfunctpreferred.preferredterm"+
      		" From orgfunctmenu " +
      		"LEFT JOIN orgevlink ON (orgfunctmenu.orgfunctionid = orgevlink.`function`) " +
  ...
  Returns:
     A Vector of all OrgEvLinks for this Event.
  */
  ...
  Purpose: Returns a record set with all of the OrgFunctMenus information in it.
  ...
  */
  ...
  public void setFunctionDesc         (String s)       {functionDesc         = s;}
  public void setArtisticFunction     (String s)       {artisticFunction     = s;}
  public void setArtisticFunctionDesc (String s)       {artisticFunctionDesc = s;}
  public void setOrganisationBean     (Organisation c) {organisationBean     = c;}

  public String       getEventId              () {return (eventId);}
  public String       getOrganisationId       () {return (organisationId);}
  public String       getFunction             () {return (function);}
  public String       getFunctionDesc         () {if(functionDesc==null){functionDesc="";}return (functionDesc);}
  public String       getArtisticFunction     () {return (artisticFunction);}
  ...
  public Organisation getOrganisationBean     () {return (organisationBean);}
  public String       getError                () {return (m_error_string);}

  public boolean sameOrganisationAndFunction (OrgEvLink orgEvLink)
  {
    if (this.toLongString().equals(orgEvLink.toLongString()))
      return true;
    return false;
  }
  ...
  {
    return eventId + " " + organisationId + " " + function + " " + functionDesc + " " +
           artisticFunction + " " + artisticFunctionDesc;
  }
