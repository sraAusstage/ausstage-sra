...
public class MaterialLink
{
  ...
  */
  ...
  Parameters:
    ...
    String array of Material Links records.
  ...
  */
  ...
  Purpose: Modifies this object in the database by deleting all MaterialLinks for this
           Collection and inserting new ones from an array of Materials records to link
           to this Collection.
  ...
  */
  public boolean update (String collectionInformationId, String [] materialLinks)
  {
    try
    {
      ...
      {
        sqlString = "DELETE FROM MATERIALLINK where " +
                    "COLLECTION_INFORMATION_ID=" + collectionInformationId;
        m_db.runSQL (sqlString, stmt);

        for (int i=0; materialLinks != null && i < materialLinks.length; i++)
        {
          sqlString = "INSERT INTO MATERIALLINK " +
                     "(materialid, collection_information_id) " +
                     "VALUES ("                   +
                      materialLinks[i]            + ", " +
                      collectionInformationId + ")";
          m_db.runSQL (sqlString, stmt);
  ...
  Purpose: Deletes all MaterialLink records for the specified Collection Information Id.

  Parameters:
    Collection Information Id
  ...
  */
  public void deleteMaterialLinksForCollection (int collectionInformationId)
  {
    try
    {
      ...
      sqlString = "DELETE from MATERIALLINK WHERE collection_information_id=" +
                  collectionInformationId;
      m_db.runSQL (sqlString, stmt);
      stmt.close ();
    }
  ...
  Purpose: Checks to see if the specified MaterialLink is in use in the database.

  Parameters:
    p_id : id of the materials record

  Returns:
     True if the MaterialLink is in use, else false
  ...
  */
  ...
  Purpose: Returns a record set with all of the MaterialLinks information in it.
  ...
  */
  public CachedRowSet getMaterialLinks(int collectionInformationId)
  {
    ...
    try
    {
      ...
      sqlString = "SELECT * FROM materiallink WHERE collection_information_id = " +
                  collectionInformationId;
      l_rs = m_db.runSQL (sqlString, stmt);
      stmt.close();
      return (l_rs);
  ...
  Purpose: Returns a Vector containing all the MaterialLinks for this Collection.

  Parameters:
    p_id: collection_information_id

  Returns:
     A Vector of all MaterialLinks for this Collection.
  */
  ...
  public void setMaterialid              (int i) {m_materialid = i;}
  public void setCollectionInformationId (int i) {m_collection_information_id = i;}

  public int    getMaterialid              () {return (m_materialid);}
  public int    getCollectionInformationId () {return (m_collection_information_id);}
