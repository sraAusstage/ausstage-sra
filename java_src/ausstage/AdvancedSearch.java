...
public class AdvancedSearch {
  ...
  void setEventInfo(String p_eventId, String p_eventName, 
                    String p_firstDateOnDD, 
                    String p_firstDateOnMM, String p_firstDateOnYYYY, 
                    String p_lastDateOnDD, 
                    String p_lastDateOnMM, String p_lastDateOnYYYY, 
                    String p_umbrella) {
    ...
    if ((p_firstDateOnDD != null && !p_firstDateOnDD.equals("")) || 
        (p_firstDateOnMM != null && !p_firstDateOnMM.equals("")) || 
        (p_firstDateOnYYYY != null && !p_firstDateOnYYYY.equals("")) || 
        (p_lastDateOnDD != null && !p_lastDateOnDD.equals("")) || 
        (p_lastDateOnMM != null && !p_lastDateOnMM.equals("")) || 
        (p_lastDateOnYYYY != null && !p_lastDateOnYYYY.equals(""))) {
  ...
  public void setGenreInfo(String p_primaryGenre, String p_secondaryGenre[]) {
    ...
    /*
    if (!p_secondaryGenre.equals("")) {
      m_secoGenreKeyAndVal = "secgenreclass.genreclass|" + p_secondaryGenre;
  ...
  public void setVenueInfo(String p_venueId, String p_venueName, 
                           String p_venueState) {
  ...
  public void setOriginsInfo(String p_origin_of_text, 
                             String p_origin_of_production) {
    ...
    if (!p_origin_of_production.equals("")) {
      m_countryKeyAndVal = 
          "productionevlink.countryid|" + p_origin_of_production;
      m_countryTableUsed = true;
  ...
  public void setOrganisationInfo(String p_organisationId, 
                                  String p_organisationName, 
                                  String p_orgFunctMenuAndContFunct) {

    Vector column_types = new Vector();

    if (!p_organisationId.equals("") || !p_organisationName.equals("")) {
      m_organisationKeyAndVal = 
          "organisation.organisationid|" + p_organisationId;
  ...
  public void setContributorInfo(String p_contributorId, 
                                 String p_contributorName, 
                                 String p_contributorFunction) {
    ...
    if (!p_contributorFunction.equals("")) {
      m_contFunctKeyAndVal = 
          "contributorfunctpreferred.preferredterm|" + p_contributorFunction;
  ...
  public void setResourceInfo(String p_resource_title, 
                              String p_resource_source, 
                              String p_resource_abstract, 
                              String p_contributor_creator, 
                              String p_organisation_creator, 
                              String[] p_resource_subTypes, 
                              String p_copyrightDateChecked, 
                              String p_issuedDateChecked, 
                              String p_accessionedDateChecked, 
                              String p_copyright_date_yyyy, 
                              String p_copyright_date_mm, 
                              String p_copyright_date_dd, 
                              String p_copyrightbetweenFromDateDD, 
                              String p_copyrightbetweenFromDateMM, 
                              String p_copyrightbetweenFromDateYYYY, 
                              String p_copyrightbetweenToDateDD, 
                              String p_copyrightbetweenToDateMM, 
                              String p_copyrightbetweenToDateYYYY, 
                              String p_issued_date_yyyy, 
                              String p_issued_date_mm, String p_issued_date_dd, 
                              String p_issuedbetweenFromDateDD, 
                              String p_issuedbetweenFromDateMM, 
                              String p_issuedbetweenFromDateYYYY, 
                              String p_issuedbetweenToDateDD, 
                              String p_issuedbetweenToDateMM, 
                              String p_issuedbetweenToDateYYYY, 
                              String p_accessioned_date_yyyy, 
                              String p_accessioned_date_mm, 
                              String p_accessioned_date_dd, 
                              String p_accessionedbetweenFromDateDD, 
                              String p_accessionedbetweenFromDateMM, 
                              String p_accessionedbetweenFromDateYYYY, 
                              String p_accessionedbetweenToDateDD, 
                              String p_accessionedbetweenToDateMM, 
                              String p_accessionedbetweenToDateYYYY) {
    ...
    if (!p_resource_title.equals("") || !p_resource_source.equals("") || 
        !p_resource_abstract.equals("")) {
      ...
      if (!p_resource_source.equals("")) {
        // need to add another item table to the list to query for the citation
      ...
      m_resourceKeyAndVal += 
          ",item.description_abstract|" + p_resource_abstract;
      column_types.addElement("string");
    ...
    // copyright date
    if (!p_copyrightDateChecked.equals("") || 
        !p_copyright_date_dd.equals("") || !p_copyright_date_mm.equals("") || 
        !p_copyright_date_yyyy.equals("") || 
        !p_copyrightbetweenFromDateDD.equals("") || 
        !p_copyrightbetweenFromDateMM.equals("") || 
        !p_copyrightbetweenFromDateYYYY.equals("") || 
        !p_copyrightbetweenToDateDD.equals("") || 
        !p_copyrightbetweenToDateMM.equals("") || 
        !p_copyrightbetweenToDateYYYY.equals("")) {

      if (p_copyrightDateChecked.equals("item copyrightdate")) { //copyright date being used
        m_copyrightDateOnDD = p_copyright_date_dd;
        m_copyrightDateOnMM = p_copyright_date_mm;
        m_copyrightDateOnYYYY = p_copyright_date_yyyy; //set member variables
        if (!p_copyright_date_yyyy.equals("")) {
          if (m_resourceDateKeyAndVal.equals(""))
            //return date clause value
            m_resourceDateKeyAndVal = 
                "item.copyright_date|" + setResourceDateClause(p_copyright_date_dd, 
                                                               p_copyright_date_mm, 
                                                               p_copyright_date_yyyy, 
                                                               p_copyrightbetweenFromDateDD, 
                                                               p_copyrightbetweenFromDateMM, 
                                                               p_copyrightbetweenFromDateYYYY, 
                                                               p_copyrightbetweenToDateDD, 
                                                               p_copyrightbetweenToDateMM, 
                                                               p_copyrightbetweenToDateYYYY, 
                                                               "copyright_date");
          else
            //return date clause value
            m_resourceDateKeyAndVal += 
        ...
        m_copyrightbetweenToDateYYYY = 
            p_copyrightbetweenToDateYYYY; //set member variables

        if (!p_copyrightbetweenFromDateYYYY.equals("") && 
            !p_copyrightbetweenToDateYYYY.equals(""))
          if (m_resourceDateKeyAndVal.equals(""))
            //return date clause value
            m_resourceDateKeyAndVal = 
    ...
    // issued date
    if (!p_issuedDateChecked.equals("") || !p_issued_date_dd.equals("") || 
        !p_issued_date_mm.equals("") || !p_issued_date_yyyy.equals("") || 
        !p_issuedbetweenFromDateDD.equals("") || 
        !p_issuedbetweenFromDateMM.equals("") || 
        !p_issuedbetweenFromDateYYYY.equals("") || 
        !p_issuedbetweenToDateDD.equals("") || 
        !p_issuedbetweenToDateMM.equals("") || 
        !p_issuedbetweenToDateYYYY.equals("")) {

      if (p_issuedDateChecked.equals("item issueddate")) { //issued date being used

        if (!p_issued_date_yyyy.equals("")) {
          if (m_resourceDateKeyAndVal.equals(""))
            //return date clause value
            m_resourceDateKeyAndVal = 
                "item.issued_date|" + setResourceDateClause(p_issued_date_dd, 
                                                            p_issued_date_mm, 
                                                            p_issued_date_yyyy, 
                                                            p_issuedbetweenFromDateDD, 
                                                            p_issuedbetweenFromDateMM, 
                                                            p_issuedbetweenFromDateYYYY, 
                                                            p_issuedbetweenToDateDD, 
                                                            p_issuedbetweenToDateMM, 
                                                            p_issuedbetweenToDateYYYY, 
                                                            "issued_date");
          else
            //return date clause value
            m_resourceDateKeyAndVal += 
        ...
        if (!p_issuedbetweenFromDateYYYY.equals("") && 
            !p_issuedbetweenToDateYYYY.equals(""))
          if (m_resourceDateKeyAndVal.equals(""))
            //return date clause value
            m_resourceDateKeyAndVal = 
    ...
    // accessioned date
    if (!p_accessionedDateChecked.equals("") || 
        !p_accessioned_date_dd.equals("") || 
        !p_accessioned_date_mm.equals("") || 
        !p_accessioned_date_yyyy.equals("") || 
        !p_accessionedbetweenFromDateDD.equals("") || 
        !p_accessionedbetweenFromDateMM.equals("") || 
        !p_accessionedbetweenFromDateYYYY.equals("") || 
        !p_accessionedbetweenToDateDD.equals("") || 
        !p_accessionedbetweenToDateMM.equals("") || 
        !p_accessionedbetweenToDateYYYY.equals("")) {


      if (p_accessionedDateChecked.equals("item accessioneddate")) { //accessioned date being used

        if (!p_accessioned_date_yyyy.equals("")) {
          if (m_resourceDateKeyAndVal.equals(""))
            //return date clause value
            m_resourceDateKeyAndVal = 
                "item.accessioned_date|" + setResourceDateClause(p_accessioned_date_dd, 
                                                                 p_accessioned_date_mm, 
                                                                 p_accessioned_date_yyyy, 
                                                                 p_accessionedbetweenFromDateDD, 
                                                                 p_accessionedbetweenFromDateMM, 
                                                                 p_accessionedbetweenFromDateYYYY, 
                                                                 p_accessionedbetweenToDateDD, 
                                                                 p_accessionedbetweenToDateMM, 
                                                                 p_accessionedbetweenToDateYYYY, 
                                                                 "accessioned_date");
          else
            //return date clause value
            m_resourceDateKeyAndVal += 
        ...
        if (!p_accessionedbetweenFromDateYYYY.equals("") && 
            !p_accessionedbetweenToDateYYYY.equals(""))
          if (m_resourceDateKeyAndVal.equals(""))
            //return date clause value
            m_resourceDateKeyAndVal = 
  ...
  **********************/
  ...
  /****************************************************************************
      this method adds the conditions into the clause
      E.G.(articleid=55, column name like '%luke%') the joins between the tables
      are added in buildFromAndLinksSqlString() method.
   *****************************************************************************/
  private void buildWhereClause(String p_hashtable, Vector p_columnTypes) {
    ...
    while (st_token.hasMoreTokens()) {
      StringTokenizer key_and_val = 
        new StringTokenizer(st_token.nextToken(), "|");
      ...
      if (!l_column_value.equals("")) {
        ...
        if (l_column_name.equals("contfunction") && 
            m_orgContFunctTableUsed == true) //only add an AND to the where clause
          m_sqlString += "";
        else
          m_sqlWhereString += " AND ";

        if (p_columnTypes.elementAt(counter).equals("string") || 
            p_columnTypes.elementAt(counter).equals("stringNoLike")) {
          if (l_column_name.equals("orgfunction") && 
              m_orgContFunctTableUsed == true) {
            m_sqlWhereString += 
                " (upper(" + l_column_name + ") like '%"+ m_db.plSqlSafeString(l_column_value.toUpperCase()).trim()+"%' " + 
                " and orgfunctmenu.orgfunctionid = orgevlink.function and orgevlink.eventid = events.eventid ";
          } else if (l_column_name.equals("contfunction") && 
                     m_orgContFunctTableUsed == true) {
            m_sqlWhereString += 
                
                " and orgfunctmenu.orgfunctionid = orgevlink.function and orgevlink.eventid = events.eventid )";
          }
          /*else if(l_column_name.equals("combined_all") && m_authorAliasTableUsed == true)
              m_sqlWhereString += "upper(author.first_name || ' ' || author.last_name) like '%" + m_db.plSqlSafeString(l_column_value.toUpperCase()).trim() + "%' ";
              */
          else if (l_column_name.equals("combined_all") && 
                   m_contribtorTableUsed == true)
            m_sqlWhereString += 
                "upper(concat_ws(' ', contributor.first_name, contributor.last_name)) like '%"+m_db.plSqlSafeString(l_column_value.toUpperCase()).trim()+"%' ";
          else if (l_column_name.equals("cont_creator.last_name") && 
                   m_creator_contributor) {
            m_sqlWhereString += 
                "upper(concat_ws(' ', cont_creator.first_name, cont_creator.last_name)) like '%"+m_db.plSqlSafeString(l_column_value.toUpperCase()).trim()+"%' ";
          } else if (p_columnTypes.elementAt(counter).equals("stringNoLike")) {
            m_sqlWhereString += 
                "upper(" + l_column_name + ") = '"+m_db.plSqlSafeString(l_column_value.toUpperCase())+"' ";
          } else
            m_sqlWhereString += 
                "upper(" + l_column_name + ") like '%"+ m_db.plSqlSafeString(l_column_value.toUpperCase()).trim()+"%' ";
        }

        else if (p_columnTypes.elementAt(counter).equals("int"))
          m_sqlWhereString += 
              l_column_name + "=" + m_db.plSqlSafeString(l_column_value.toUpperCase()).trim() + 
              " ";
      }
      counter++;
    }
  ...
  private void buildInWhereClause(String p_field_with_val, 
                                  Vector p_columnTypes) {
    String l_column_name = "";
    ...
    // if the column type is a collection of int values then no need for safe string
    // otherwise apply a safe string wrap to the collection ie. e,r,t -> 'e','r','t'
    ...
    m_sqlWhereString += " AND ";
    m_sqlWhereString += 
        l_column_name + " in (" + l_column_values.trim() + ") ";
  ...
  public void buildFromAndLinksSqlString() {
    ...
    if (m_organisationTableUsed == true) { //for organisation id, name search
    ...
    if (m_contribtorTableUsed == true) { //for contributor id and name search
    ...
    if (m_countryTableUsed == true) { //link tables for "origins of text" and "origins of production"
    ...
    if (m_orgContFunctTableUsed == true) { //for search for organisation functions and contributor functions in one go
      m_sqlFromString += "inner join orgevlink on (orgevlink.eventid=events.eventid) " + 
		"inner join orgfunctmenu on orgfunctmenu.orgfunctionid = orgevlink.function ";
    }
    ...
    if (m_secGenreClassTableUsed == true) { //for secondary genre search
      m_sqlFromString += 
          "inner join secgenreclasslink on secgenreclasslink.eventid = events.eventid " +
  ...
  public CachedRowSet getResult() {
    //By selecting * from original query, allows you to add assoc_item to the where clause without doing the decode again.

    m_sqlString = 
        "SELECT events.eventid, events.event_name, events.status, venue.venue_name, venue.suburb, " + 
        ...
        " count(distinct ie.itemid) as total  "+
        " FROM " + m_sqlFromString + " inner join states on states.stateid=venue.state left join itemevlink ie on ie.eventid = events.eventid  left join item i on i.itemid = ie.itemid " + 
        " WHERE " + m_sqlWhereString;
    ...
    m_sqlString += " group by  events.eventid, events.event_name, events.status, venue.venue_name, venue.suburb," +
                   " venue.state , " +
                   " states.state, events.first_date";
  ...
  public String setResourceDateClause(final String day, final String month, 
                                      final String year, final String dayFrom, 
                                      final String monthFrom, 
                                      final String yearFrom, 
                                      final String dayTo, final String monthTo, 
                                      final String yearTo, 
    ...
    Search search = 
      new Search(m_db); //created so I can use the getNumberOfDays method.

    //if m_dateClause has already been used we need to add and AND into the clause
    if (!m_dateClause.equals("")) {
      m_dateClause += " and ";
    }
    ...
    ************************************************/
    ...
    if (l_DateOnYYYY != null && !l_DateOnYYYY.equals("")) {
      ...
      if (!l_DateOnDD.equals("")) {
        m_dateClause += 
            " " + l_tableCol + "=to_date('" + l_DateOnYYYY + "-" + l_DateOnMM + 
            "-" + l_DateOnDD + "','yyyy-mm-dd') ";

      } else if (!l_DateOnMM.equals("") && !l_DateOnYYYY.equals("")) {

        if (l_DateOnMM.equals("02")) {

          // do some leap year testing - from other code, so its been kept as it works
          GregorianCalendar cal = new GregorianCalendar();
          if (cal.isLeapYear(Integer.parseInt(l_DateOnYYYY))) {
            m_dateClause += 
                (" (" + l_tableCol + " between to_date('" + l_DateOnYYYY + 
                 "-02-01','yyyy-mm-dd') and ");
            m_dateClause += 
                ("to_date('" + l_DateOnYYYY + "-02-29','yyyy-mm-dd')) ");
          } else {
            m_dateClause += 
                (" (" + l_tableCol + " between to_date('" + l_DateOnYYYY + 
                 "-02-01','yyyy-mm-dd') and ");
            m_dateClause += 
                ("to_date('" + l_DateOnYYYY + "-02-28','yyyy-mm-dd')) ");
          }

        } else {
          // lets get the last date of the given month & year
          String num_of_days = 
            Integer.toString(search.getNumberOfDays(l_DateOnMM, 
                                                    Integer.parseInt(l_DateOnYYYY)));

          m_dateClause += 
              (" (" + l_tableCol + " between to_date('" + l_DateOnYYYY + "-" + 
               l_DateOnMM + "-01','yyyy-mm-dd') and ");
          m_dateClause += 
              ("to_date('" + l_DateOnYYYY + "-" + l_DateOnMM + "-" + 
               num_of_days + "','yyyy-mm-dd')) ");
        }
        ...
        m_dateClause += 
            ("to_date('" + l_DateOnYYYY + "-12-31','yyyy-mm-dd')) ");
      }

    } else if ((l_betweenFromDateYYYY != null && 
                !l_betweenFromDateYYYY.equals("")) && 
               (l_betweenToDateYYYY != null && 
                !l_betweenToDateYYYY.equals(""))) {
      ...
      if (!l_betweenFromDateDD.equals("")) {
        m_dateClause += 
            (" (" + l_tableCol + " between to_date('" + l_betweenFromDateYYYY + 
             "-" + l_betweenFromDateMM + "-" + l_betweenFromDateDD + 
             "','yyyy-mm-dd') and ");
      } else if (!l_betweenFromDateMM.equals("") && 
                 !l_betweenFromDateYYYY.equals("")) {
        m_dateClause += 
            (" (" + l_tableCol + " between to_date('" + l_betweenFromDateYYYY + 
             "-" + l_betweenFromDateMM + "-01','yyyy-mm-dd') and ");
      } else { // only YEAR is specified
        m_dateClause += 
            (" (" + l_tableCol + " between to_date('" + l_betweenFromDateYYYY + 
             "-01-01','yyyy-mm-dd') and ");
      ...
      if (!l_betweenToDateDD.equals("")) {
        m_dateClause += 
            ("to_date('" + l_betweenToDateYYYY + "-" + l_betweenToDateMM + 
             "-" + l_betweenToDateDD + "','yyyy-mm-dd')) ");
      } else if (!l_betweenToDateMM.equals("") && 
                 !l_betweenToDateYYYY.equals("")) {
        ...
        if (l_betweenToDateMM.equals("02")) {
          ...
          if (cal.isLeapYear(Integer.parseInt(l_betweenToDateYYYY))) {
            m_dateClause += 
                ("to_date('" + l_betweenToDateYYYY + "-02-29','yyyy-mm-dd')) ");
          } else {
            m_dateClause += 
                ("to_date('" + l_betweenToDateYYYY + "-02-28','yyyy-mm-dd')) ");
          }

        } else {
          // lets get the last date of the given month & year
          String num_of_days = 
            Integer.toString(search.getNumberOfDays(l_betweenToDateMM, 
                                                    Integer.parseInt(l_betweenToDateYYYY)));
          m_dateClause += 
              ("to_date('" + l_betweenToDateYYYY + "-" + l_betweenToDateMM + 
               "-" + num_of_days + "','yyyy-mm-dd')) ");
        }
        ...
        m_dateClause += 
            ("to_date('" + l_betweenToDateYYYY + "-12-31','yyyy-mm-dd')) ");
      }
    }
