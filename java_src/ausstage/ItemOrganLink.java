  ...
  */
  public void load(String p_ITEMORGLINKID, String p_creator_flag)
  {
    ...
    try
    {
      ...
      sqlString = " SELECT * FROM ITEMORGLINK " +
                  " WHERE ITEMORGLINKID = " + p_ITEMORGLINKID +
                  "   AND ((creator_flag is NULL and '" + p_creator_flag + "'='N') or creator_flag='" + p_creator_flag + "')" ;
  ...
  */
  public boolean update (String p_itemId, Vector p_organLinks, String p_creator_flag)
  {
    try
    {
      ...
      sqlString = "DELETE FROM ITEMORGLINK where " +
                  " itemId=" + p_itemId +
                  " AND ((creator_flag is NULL and '" + p_creator_flag + "'='N') or creator_flag='" + p_creator_flag + "')";
      ...
      for (int i=0; p_organLinks != null && i < p_organLinks.size(); i++){
        ...
        sqlString = "INSERT INTO ITEMORGLINK "    +
                    "(itemId, ORGANISATIONID,creator_flag, orderBy, function_lov_id) " +
                    "VALUES (" +
                    p_itemId + ", " + itemOrganLink.getOrganisationId() + ",'" + p_creator_flag + "'," + itemOrganLink.getOrderBy() + ", " + functionId + ")";
        m_db.runSQL (sqlString, stmt);
      }
      l_ret = true;
  ...
  public void setOrganisationId  (String s) {organId       = s;}
  public void setOrderBy         (String s) {orderBy       = s;}
  public void setFunctionId      (String s) {functionLovId = s;}
  public void setCreatorFlag     (String s) {creatorFlag   = s;}
  
  


  public String              getItemId          () {return (itemId);}
  public String              getOrganisationId  () {return (organId);}
  public String              getOrderBy         () {return (orderBy);}
  public String              getFunctionId      () {return (functionLovId);}
  public String              getCreatorFlag     () {return (creatorFlag);}
