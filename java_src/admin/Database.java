...
public class Database
{
    ...
    public String connDatabase(String p_user, String p_password)
    {
        try
        {
            ...
            m_conn = DriverManager.getConnection("jdbc:oracle:thin:@DBInfonet:1521:INFONET", "ausstage_centric", "srasra");
        }
        catch(Exception e)
        {
    ...
    public ResultSet runSQLResultSet(String p_sqlString, Statement p_stmt)
        throws Exception
    {
        ResultSet rset = null;
        try
    ...
    public CachedRowSet runSQL(String p_sqlString, Statement p_stmt)
        throws Exception
    {
        try
        {
...
label0:
    ...
    private String getInsertedIndex(Statement p_stmt, String p_sequence_name)
        throws Exception
    {
        String sqlString = "";
        try
    ...
    private String getInsertedIndex(Statement p_stmt)
        throws Exception
    {
        String sqlString = "";
        try
...
label3:
    ...
    public String safeDateFormat(Date p_date, boolean p_include_time)
    {
        ...
        case 1: // '\001'
            if(p_include_time)
            {
                l_result = "TO_DATE('" + l_cal.get(1) + "/" + (l_cal.get(2) + 1) + "/" + l_cal.get(5) + ":" + l_cal.get(11) + ":" + l_cal.get(12) + ":" + l_cal.get(13) + "', 'yyyy/mm/dd:hh24:mi:ss')";
            } else
            {
