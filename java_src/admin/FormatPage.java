...
public class FormatPage
{
    ...
    public void writePageTableHeader(JspWriter p_out, String p_tableTitle, String p_addition_html)
    {
        try
        {
            p_out.println("<table border='0' style='border-collapse: collapse' bordercolor='#111111' width=" +
"'778' cellspacing='0' cellpadding='0'>"
    ...
    public void writeTwoColTableHeader(JspWriter p_out, String p_text)
    {
        try
        {
            ...
            p_out.println("<tr>");
            p_out.println("  <td valign='top' align='left' width='90'><img src='/custom/images/spacer.gif' w" +
"idth='90' height='1' border='0'></td>"
);
            p_out.println("  <td valign='top' align='left' width='125' class='heading'><img src='/custom/ima" +
"ges/spacer.gif' width='125' height='1' border='0'></td>"
);
            p_out.println("  <td valign='top' align='left' width='285' class='bodytext'><img src='/custom/im" +
"ages/spacer.gif' width='285' height='1' border='0'></td>"
);
            p_out.println("</tr>");
            p_out.println("<tr>");
            p_out.println("  <td valign='top' align='left' width='90'><img src='/custom/images/spacer.gif' w" +
"idth='90' height='1' border='0'></td>"
    ...
    public void writeTwoColTableFooter(JspWriter p_out)
    {
        try
        {
            ...
            p_out.println("</tr>");
            p_out.println("<tr>");
            p_out.println("  <td valign='top' align='left' colspan='3' width='500'><img src='/custom/images/" +
"spacer.gif' width='500' height='10' border='0'></td>"
);
            p_out.println("</tr>");
            p_out.println("</table>");
        }
    ...
    public void writeHTMLHeader(JspWriter p_out)
    {
        try
        {
            ...
            p_out.println("<tr>");
            p_out.println("  <td valign='top' align='left' width='83'><img src='/custom/images/spacer.gif' w" +
"idth='83' height='1' border='0'></td>"
);
    ...
    public void writeSmallWindowHeader(JspWriter p_out, String p_tableTitle)
    {
        try
        {
            p_out.println("<html><head><link rel='stylesheet' type='text/css' href='/admin/admin.css'><titl" +
"e></title></head>"
);
            p_out.println("<body marginwidth='0' marginheight='0' leftmargin='0' topmargin='0'>");
            p_out.println("<table border='0' style='border-collapse: collapse' bordercolor='#111111' width=" +
"'100%' cellspacing='0' cellpadding='0' height='50'>"
);
            p_out.println("<tr>");
            ...
            p_out.println("<tr>");
            p_out.println("<td width='15' align='left' valign='top'><img border='0' src='/custom/images/spac" +
"er.gif' width=15 height=1></td>"
);
            p_out.println("<td bgcolor='#FFFFFF' class='bodyhead'></td>");
            p_out.println("<td class='bodytext' width=15><img border='0' src='/custom/images/spacer.gif' WID" +
"TH='15' HEIGHT='1'></td>"
);
            p_out.println("</tr>");
            p_out.println("<tr>");
...
">"
            ...
            p_out.println("<tr>");
            p_out.println("<td width='30' align='left' valign='top'><img border='0' src='/custom/images/cm_b" +
"ox.gif'></td>"
);
            p_out.println("<td width='100%' align='right' valign='middle'><img border='0' src='/custom/image" +
"s/spacer.gif' height='1' width='100%'></td>"
);
            p_out.println("<td width='30' align='left' valign='middle'><img border='0' src='/custom/images/c" +
"m_title.gif'></td>"
);
            p_out.println("</tr>");
            p_out.println("</table>");
...
"TH='15' HEIGHT='1'></td>"
    ...
    public void writeSmallWindowButtons(JspWriter p_out, String p_btn1_img, String p_btn1_js, String p_btn2_img, String p_btn2_js)
    {
        try
        {
            ...
            p_out.println("<table border='0' width='500' cellspacing='0' cellpadding='0'>");
            p_out.println("<tr>");
            p_out.println("<td align='left' valign='middle' width='250'><img border='0' src='/custom/images/" +
"spacer.gif' width='250' height='1'></td>"
);
            p_out.println("<td align='right' valign='middle' width='250'><img border='0' src='/custom/images" +
"/spacer.gif' width='250' height='1'></td>"
);
            p_out.println("</tr>");
            p_out.println("<tr>");
...
"TH='15' HEIGHT='1'></td>"
    ...
    public void writeHelper(JspWriter p_out, String p_text, String p_helper_image)
    {
        try
        {
            ...
            p_out.println("\t\t<td width='17' bgcolor='#FFFFFF'><img border='0' src='/custom/images/helper_t" +
"ab.gif' width='16' height='31'></td>"
);
...
"'550' cellspacing='0' cellpadding='0'>"
            ...
            {
                p_out.println("<td width='26' bgcolor='#FFFFFF' align='left'><img src='/custom/images/spacer.gif" +
"' width='26' height='27' border='0'></td>"
);
            } else
            if(p_url_btn1.toUpperCase().equals("SUBMIT"))
            {
                p_out.println("<td width='26' bgcolor='#FFFFFF'><input type='image' name='go' id='go' src='/custom" +
"/images/"
 + p_img_btn1 + "' border='0'></td>");
            } else
            {
                p_out.println("<td bgcolor='#FFFFFF'><a href='" + p_url_btn1 + "'><img src='" + "/custom/images" + "/" + p_img_btn1 + "' border='0'></a></td>");
            }
            p_out.println("\t<td width='25' bgcolor='#FFFFFF'><img src='/custom/images/spacer.gif' width='25" +
"' height='20' border='0'></td>"
);
            if(p_url_btn2.equals(""))
            {
                p_out.println("<td width='26' bgcolor='#FFFFFF'><img src='/custom/images/spacer.gif' width='26' " +
"height='27' border='0'></td>"
);
            } else
            if(p_url_btn2.toUpperCase().equals("SUBMIT"))
            {
                p_out.println("<td bgcolor='#FFFFFF'><input type='image' name='go' id='go' src='/custom" +
"/images/"
 + p_img_btn2 + "' border='0'></td>");
            } else
            {
                p_out.println("<td bgcolor='#FFFFFF'><a href='" + p_url_btn2 + "'><img src='" + "/custom/images" + "/" + p_img_btn2 + "' border='0'></a></td>");
            }
            p_out.println("\t<td bgcolor='#FFFFFF' width='465'><img src='/custom/images/spacer.gif' width='4" +
"65' height='27' border='0'></td>"
);
...
"height='27' border='0'></td>"
            ...
            if(p_url_btn3.toUpperCase().equals("SUBMIT"))
            {
                if(p_validateFunction_btn3.equals(""))
                {
                    p_out.println("<td bgcolor='#FFFFFF'><input type='image' name='go' id='go' src='/custom" +
"/images/"
 + p_img_btn3 + "' border='0'></td>");
                } else
                {
                    p_out.println("<td bgcolor='#FFFFFF'><img name='go' id='go' src='/custom/images/" + p_img_btn3 + "' onclick='" + p_validateFunction_btn3 + "' style='cursor:hand' border='0'></td>");
                }
            } else
            {
                p_out.println("<td bgcolor='#FFFFFF'><a href='" + p_url_btn3 + "'><img src='" + "/custom/images" + "/" + p_img_btn3 + "' border='0'></a></td>");
            }
            p_out.println("\t<td bgcolor='#FFFFFF' width='10'><img src='/custom/images/spacer.gif' width='10" +
"' height='27' border='0'></td>"
);
            p_out.println("</tr>");
            p_out.println("</table>");
...
"idth='90' height='1' border='0'></td>"
    ...
    public void writeOneButtonMenuLink(JspWriter p_out, String p_text, String p_url, String p_image)
    {
        try
        {
            ...
            if(p_url.toUpperCase().equals("BACK"))
            {
            ...
            p_out.println("<tr>");
            p_out.println("<td valign='top' align='left' width='90'><img src='./images/spacer.gif' width='9" +
"0' height='17' border='0'></td>"
);
            ...
            p_out.println("  <td width='5'><img border='0' src='/custom/images/spacer.gif' WIDTH='5' HEIGHT=" +
"'1'></td>"
);
...
"'1'></td>"
    ...
    public void writeListWithButtons(JspWriter p_out, String p_text, String p_url1, String p_image1, String p_url2, String p_image2, String p_url3, 
            String p_image3)
    {
        try
        {
...
"'1'></td>"
    ...
    public void writeListWithButtons(JspWriter p_out, String p_text, String p_url1, String p_image1, String p_url2, String p_image2, String p_url3, 
            String p_image3, String p_url4, String p_image4)
    {
        try
        {
            String p_type1 = "";
...
"'1'></td>"
            ...
            {
                p_out.println("  <td width='55'><img border='0' src='/custom/images/spacer.gif' WIDTH='55' HEIGH" +
"T='1'></td>"
);
            } else
            {
...
"T='1'></td>"
    ...
    public void writeMultiList(JspWriter p_out, String leftBoxName, Vector leftIdArray, Vector leftTextArray, String rightBoxName, Vector rightIdArray, Vector rightTextArray)
    {
        ...
        {
            System.out.println("An exception occurred in writeMultiList() when trying to access the JspWriter ob" +
"ject"
);
        }
    }
