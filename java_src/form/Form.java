...
public class Form
{
    ...
    public void addForm(Statement stmt, String form_name, String form_method, String submit_caption, String reset_caption, String is_multipart, String cancel_back_caption, 
            String is_approved, String real_form_id, String approval_requested, String modified_by_auth_id, String form_type)
        throws Exception
    {
...
"on, is_multipart, cancel_back_caption, is_approved, real_form_id, approval_reque" +
"sted, modified_by_auth_id, form_type) values ('"
 + form_name + "','" + form_method + "','" + submit_caption + "','" + reset_caption + "','" + is_multipart + "','" + cancel_back_caption + "','" + is_approved + "','" + real_form_id + "','" + approval_requested + "','" + modified_by_auth_id + "','" + form_type + "')";
        try
        {
    ...
    public String copyForm(Statement stmt, String form_id, String is_approved, String real_form_id, String approval_requested, String modified_by_auth_id)
        throws Exception
    {
        ...
        try
        {
            ...
            if(rset.next())
            {
                ...
                addForm(xstmt, rset.getString("form_name"), rset.getString("form_method"), rset.getString("submit_caption"), rset.getString("reset_caption"), rset.getString("is_multipart"), rset.getString("cancel_back_caption"), is_approved, real_form_id, approval_requested, modified_by_auth_id, rset.getString("form_type"));
                unApprovedFormId = db.getInsertedIndexValue(xstmt, "form_id_seq");
                rset.close();
                rset = flm.getFormLayout(form_id);
                if(rset != null)
                {
                    form_layout_id = flm.CopyFormLayout(rset.getString("layout_table_rows"), rset.getString("layout_table_cols"), rset.getString("layout_table_cellpadd"), rset.getString("layout_table_cellspace"), rset.getString("layout_table_border"), rset.getString("layout_table_width"), rset.getString("layout_table_align"), unApprovedFormId, stmt);
                    ...
                    for(int n = 0; n < feVector.size(); n++)
                    {
                        ...
                        fem.insertFormElement(formElement.getTypeName(), formElement.getHtmlName(), formElement.getDisplayName(), formElement.getTableRowLocation(), formElement.getTableColLocation(), formElement.getSizeLength(), formElement.getDoValidate(), formElement.getDefaultVal(), formElement.getDefaultDisplayVal(), formElement.getNumRows(), formElement.getNumCols(), new_group_id, formElement.getIsSelected(), form_layout_id, formElement.getIsMultiSelect(), formElement.getFieldType(), stmt, db);
                    }
    ...
    public void updateForm(Statement stmt, String form_name, String form_method, String submit_caption, String reset_caption, String form_id, String cancel_back_caption, 
            String ismultipart, String is_approved, String real_form_id, String approval_requested, String modified_by_auth_id)
        throws Exception
    {
        ...
        sqlString = "update form_repository set form_name = '" + form_name + "', form_method = '" + form_method + "', submit_caption = '" + submit_caption + "', reset_caption = '" + reset_caption + "', cancel_back_caption ='" + cancel_back_caption + "', is_multipart ='" + ismultipart + "', is_approved = '" + is_approved + "',  real_form_id = '" + real_form_id + "', approval_requested = '" + approval_requested + "', modified_by_auth_id ='" + modified_by_auth_id + "' where form_id = " + form_id;
        try
        {
            db.runSQL(sqlString, stmt);
        }
        ...
        try
        {
            ...
            if(rset.next())
            {
                do
                {
                    ...
                    sqlString = "select form_element.form_element_id from form_element, form_layout where form_el" +
"ement.form_layout_id="
 + form_layout_id;
...
"rm_rel where form_layout_form_rel.flfr_id=form_process.flfr_id and form_layout_f" +
"orm_rel.form_id="
 + form_id;
...
"sitory.form_type='subscription' and form_repository.form_id=form_layout.form_id " +
"and form_layout.form_layout_id="
 + form_layout_id;
        }
        try
        {
