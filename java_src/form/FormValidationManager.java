...
public class FormValidationManager
{
    ...
    public String buildJavaScriptValidatator(String form_layout_id, String html_name, String field_type, String display_name, String default_value)
    {
        ...
        try
        {
            ...
            sqlString = "select form_repository.form_name from form_repository, form_layout where form_la" +
"yout.form_id=form_repository.form_id and form_layout.form_layout_id="
 + form_layout_id;
