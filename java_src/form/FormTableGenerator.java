	...
	public FormTableGenerator(String form_layout_id, Database db) {
		...
		try {
			...
			finalhtmlFormFooter = "\n<tr><td colspan='" + cols + "'>\n" + finalhtmlFormTableHeader + "<tr>\n<td align='left'>"
					+ "<input class=INPUT_BUTTON type='button' onclick='Javascript:history.back();' val" + "ue='" + cancel_back_caption
					+ "'></td>\n<td align='center'><input class=INPUT_BUTTON type='reset' value='" + reset_caption
			...
			htmlFormHeader = "\n\n<form method='POST' name='editForm' action='content_form_edit_element_locati"
					+ "on.jsp'>\n<input type='hidden' name='element_id' value=''>\n<input type='hidden'" + " name='form_layout_id' value='" + form_layout_id + "'>\n"
