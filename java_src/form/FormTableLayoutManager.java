...
public class FormTableLayoutManager
{
    ...
    public void addFormLayout(String form_id, String rows, String cols, String cellpadd, String cellspace, String tabel_border, String tabel_width, 
            String tabel_align, Statement stmt)
    {
        sqlString = "insert into form_layout (form_id, layout_table_rows, layout_table_cols, layout_t" +
"able_cellpadd, layout_table_cellspace, layout_table_border, layout_table_width, " +
"layout_table_align) values ('"
 + form_id + "','" + rows + "','" + cols + "','" + cellpadd + "','" + cellspace + "','" + tabel_border + "','" + tabel_width + "','" + tabel_align + "')";
        try
        {
    ...
    public void updateFormLayout(String form_layout_id, String rows, String cols, String cellpadd, String cellspace, String tabel_border, String tabel_width, 
            String table_align, Statement stmt)
    {
        sqlString = "update form_layout set layout_table_rows='" + rows + "', layout_table_cols='" + cols + "', layout_table_cellpadd='" + cellpadd + "', layout_table_cellspace='" + cellspace + "', layout_table_border='" + tabel_border + "', layout_table_width='" + tabel_width + "', layout_table_align='" + table_align + "' where form_layout_id=" + form_layout_id;
        try
        {
            db.runSQLResultSet(sqlString, stmt);
        }
    ...
    public void updateFormHtmlLayout(String finalFormHtmlStr, String form_layout_id, Statement stmt)
    {
        ...
        {
            System.out.println("Trying to update the htmlformlayout in the form_layout table - We have an except" +
"ion!!!"
);
        }
    }
...
"e_align, form_id from form_layout where form_layout_id="
 + form_layout_id;
        try
        {
    ...
    public String getLayoutTableStructure(String form_layout_id, String layout_table_width, String rows, String cols)
    {
        ...
        for(int r = 1; r < numRow + 1; r++)
        {
            ...
            for(int c = 1; c < numCol + 1; c++)
            {
                ...
                {
                    RowColTag = RowColTag + LayoutRenderrer(form_layout_id, layout_table_width, size_length, display_name, type_name, html_name, default_val, num_rows, num_cols, default_display_val, element_id, numTableCol, is_selected, element_group_id, is_multiselect);
                    RowColTag = RowColTag + "\t</td>\n";
                    finalHtmlFormStr += "\t</td>\n";
                } else
                {
                    RowColTag = RowColTag + ("><div onclick=\"setAddElementLocation('" + r + "','" + c + "','" + form_layout_id + "'); styleBkrnd(this);\" onmouseover=\"this.style.cursor='hand';\">" + "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr>\n<td>&nbsp;\n" + "</td>\n</tr>\n</table>\n</div>\n</td>\n");
                    finalHtmlFormStr += ">&nbsp;</td>\n";
                }
            }
    ...
    private String LayoutRenderrer(String form_layout_id, String layout_table_width, String size_length, String display_name, String type_name, String html_name, String default_val, 
            String rows, String cols, String default_display_val, String element_id, String numTableCol, String is_selected, String element_group_id, 
            String is_multiselect)
    {
        String RowColTag = "";
        String htmlElement = "";
...
">"
 + default_val + getLayoutRenderedFooter() + "\n";
            RowColTag = RowColTag + (htmlElement + getLayoutRenderedFooter() + getElementOnclickControlEnd());
        } else
        {
            htmlElement = getHtmlElement(type_name, size_length, html_name, default_val, rows, cols, default_display_val, is_selected, element_group_id, is_multiselect, form_layout_id, element_id);
            RowColTag = ">" + getLayoutRenderedHeader(display_name, type_name, form_layout_id, element_id);
            temp_rowcoltag = ">" + getElementOnclickControlBegin(form_layout_id, element_id) + getLayoutRenderedHeader(display_name, type_name, form_layout_id, element_id) + htmlElement;
...
"=INPUT_LABEL>"
 + display_name;
        ...
        {
            LayoutRenderedHeader = "<table width='100%' border='0' cellspacing='0' cellpadding='0'>\n<tr>\n<td valig" +
"n='top' align='left' class=INPUT_TITLE>"
 + display_name + "</td>\n" + "</tr>\n<tr>\n<td valign='top' align='left'>";
    ...
    private String getHtmlElement(String TypeName, String sizeLength, String htmlName, String defaultVal, String rows, String cols, String default_display_val, 
            String is_selected, String element_group_id, String is_multiselect, String form_layout_id, String element_id)
    {
        String htmlElement = "";
        String subStr = "";
        ...
        if(TypeName.toUpperCase().equals("SELECTION"))
        {
        ...
        if(TypeName.toUpperCase().equals("CHECKBOX"))
        {
        ...
        if(TypeName.toUpperCase().equals("RADIOBUTTON"))
        {
            if(!element_group_id.equals(""))
            {
                htmlName = formElementsManager.getElementGroupName(element_group_id, db);
...
"<td align='center'><a href=\"#\" onclick=\"ViewForm('"
 + form_layout_id + "');\"><img src='" + "/custom/images" + "/view.gif' alt='view form' border=0></a></td>\n" + "<td>&nbsp;</td></tr></table>";
        return formEditCtrl;
    }
    ...
    private void unSelectOtherButton(String element_id, String element_group_id, String form_layout_id)
    {
        ...
        {
            sqlString = "select form_element_id, is_selected, form_element_group_id, form_layout_id from " +
"form_element where form_layout_id= "
 + form_layout_id + " " + "and not form_element_id=" + element_id + " and is_selected='true'";
            try
            {
                Statement stmt = db.m_conn.createStatement();
