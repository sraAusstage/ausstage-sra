...
public class FormLayoutManager {
	...
	public String CopyFormLayout(String layout_table_rows, String layout_table_cols, String layout_table_cellpadd, String layout_table_cellspace, String layout_table_border,
			String layout_table_width, String layout_table_align, String form_id, Statement stmt) throws Exception {
		String form_layout_id = "";
		try {
			ftlm.addFormLayout(form_id, layout_table_rows, layout_table_cols, layout_table_cellpadd, layout_table_cellspace, layout_table_border, layout_table_width,
					layout_table_align, stmt);
