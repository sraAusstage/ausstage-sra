...
public class HtmlGenerator {
	...
	public String displaySearchFilter(HttpServletRequest p_request, String p_title, Vector p_filter_display_names, Vector p_filter_names, Vector p_order_display_names,
		...
		//System.out.println(p_list_db_sql);
	...
	public String displaySearchFilter(HttpServletRequest p_request, String p_title, Vector p_filter_display_names, Vector p_filter_names, Vector p_order_display_names,
		...
		return displaySearchFilter(p_request, p_title, p_filter_display_names, p_filter_names, p_order_display_names,
				p_order_names, p_list_name, p_list_db_sql, p_list_db_field_id_name, p_list_db_display_fields, p_buttons_names,
				p_buttons_actions, p_multiple, p_max_results_displayed, p_additional_html, "");
	}
	
	
	
	// Overloading Method to accomodate double additional html
	public String displaySearchFilter(HttpServletRequest p_request, String p_title, Vector p_filter_display_names, Vector p_filter_names, Vector p_order_display_names,
			Vector p_order_names, String p_list_name, String p_list_db_sql, String p_list_db_field_id_name, Vector p_list_db_display_fields, Vector p_buttons_names,
			Vector p_buttons_actions, boolean p_multiple, int p_max_results_displayed, String p_additional_html,String p_second_html) {

		f_id = p_request.getParameter("f_id");

		try {
			//System.out.println(p_additional_html);
			//System.out.println(p_second_html);
			String ret = "";
			...
			ret += searchFilterCriteria(p_filter_names, p_filter_display_names, p_request, p_additional_html,p_second_html);
	...
	private String searchFilterCriteria(Vector p_filter_names, Vector p_filter_display_names, HttpServletRequest p_request, String p_additional_html) {
		return searchFilterCriteria(p_filter_names, p_filter_display_names, p_request, p_additional_html, "");
	}

	// Overloading Method for additional html
	private String searchFilterCriteria(Vector p_filter_names, Vector p_filter_display_names, HttpServletRequest p_request, String p_additional_html,String p_second_html) {
		String ret = "";
		...
		if (p_second_html!=null &&!p_second_html.equals("")) {
			ret += p_second_html;
		}
		...
		if (p_additional_html !=null && !p_additional_html.equals("")) {
		...
		try {
			...
			if (!sqlString.equals("")) {
				...
				while (rset.next()) {
					...
					//System.out.println(p_list_db_display_fields.elementAt(0).toString());
					
					for (int i = 0; i < p_list_db_display_fields.size(); i++) {
						//System.out.println(p_list_db_display_fields.elementAt(i).toString());
						//System.out.println(rset.getString(p_list_db_display_fields.elementAt(i).toString()));
