...
<%@ page import="ausstage.AusstageCommon, admin.AppConstants"%>
...
<%
	...
	db_ausstage.connReadOnlyDatabase(constants.DB_READONLY_USER_NAME, constants.DB_READONLY_USER_PASSWORD);
	//db_ausstage.connReadOnlyDatabase(ausstage_search_appconstants_for_result.DB_PUBLIC_USER_NAME, ausstage_search_appconstants_for_result.DB_PUBLIC_USER_PASSWORD);
