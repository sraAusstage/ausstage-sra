...
//  System.out.println("contrib_addedit message : action = "+ action);  
  ...
  out.println("<form name='f_contributor_addedit' id='contrib_addedit_form' action='contrib_addedit_process.jsp' method='post' onsubmit='return checkFields();'>");
...
<!--
  ...
  function checkFields(){
    ...
    var msg = "";
    if(document.f_contributor_addedit.f_f_name.value =="" && document.f_contributor_addedit.f_l_name.value =="")
      msg += "\t- First Name and Last Name, one or both names are required\n";
