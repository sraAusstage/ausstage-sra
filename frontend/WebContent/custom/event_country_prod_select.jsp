...
<%
  ...
  CachedRowSet  rset;
  String delimited_country_ids =  request.getParameter("f_delimeted_ids_11_1");
  String countryLeadingSubString = "", countryTrailingSubString = "";
  
  if (delimited_country_ids == null) {
    delimited_country_ids = "";
  }
...
%>
  <form action='event_country_prod_select_process.jsp' name='content_form' id='content_form' method='post'><%
