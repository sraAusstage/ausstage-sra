		...
		**********************************************/
		...
		if(crset != null && crset.next()){
			...
			%>
				<thead>          
				<tr>
				<th width="25%" ><b><a href="#" onClick="reSortData('venue_name')">Name</a></b></th>
				<th width="35%" ><b><a href="#" onClick="reSortData('street')">Address</a></b></th>
	            		<th width="10%"><b><a href="#" onClick="reSortData('dates')">Event Dates</a></b></th>
	            		<th width="15%" align='right' style="text-align:right"><b><a href="#" onClick="reSortData('num')">Events</a></b></th>
				<th width="15%" align='right' style="text-align:right" ><b><a href="#" onClick="reSortData('total')">Resources</a></b></th>
				</thead>
				</tr>
			<%
			...
			do{
				...
				if(do_print){
					...
					%>
					<tr>
					<td " <%= bgcolour%> " valign="top" width="25%" ><a href="/pages/venue/<%=crset.getString("venueid") %>" onmouseover="this.style.cursor='hand';"><%= crset.getString("venue_name") %></a></td>
                   			<td " <%= bgcolour%>  " valign="top" width="35%" >
					<%
					...
					<td <%=bgcolour%> align="left" valign="top" width="10%">
					...
					%>
						<td <%=bgcolour%> align="right" valign="top" width="15%"></td>
					<%   
					}else{
					%>
						<td <%=bgcolour%> align="right" valign="top" width="15%"><%= crset.getString("num")%></td>   
					<%
					}          
					...
					%>
						<td <%=bgcolour%> align="right" valign="top" width="15%"><%= crset.getString("total")%></td>   
					<%
					}
            				%>
            				</tr>
