		...
		if(crset != null && crset.next()){
			...
			<tr>
			     <th width="40%"><b><a href="#" onClick="reSortData('work_title')">Name</a></b></th>
		             ...
		             <th width="15%" align="right" style="text-align:right"><b><a href="#" onClick="reSortData('events')">Events</a></b></th>
		             <th width="15%" align="right" style="text-align:right"><b><a href="#" onClick="reSortData('resources')">Resources</a></b></th>
			</thead>
			</tr>
       			 <%
			counter       = 0;
			...
			<tfoot>
				...
				<tr width="100%" class="search-bar b-153" style="height:2.5em;">
				<td align="right" colspan="9" >
				<div class="search-index search-index-work">
			<%    
