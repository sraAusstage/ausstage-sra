		...
		if(crset != null && crset.next()){
			...
			do{
				...
				if(do_print){
					...
					out.println("      <tr>");                                               
					out.println("       <td " + bgcolour +  " valign=\"top\" width=\"215\" ><a href=\"/pages/country/" + crset.getString("countryid") + "\" onmouseover=\"this.style.cursor='hand';\">" + crset.getString("countryname")+  "</a></td>");
					out.println("       <td " + bgcolour +  " valign=\"top\" width=\"277\" >"+((crset.getString("venuecount").equals("0"))?"":crset.getString("venuecount")) + "</td>");                        
					out.println("       <td " + bgcolour +  " valign=\"top\" width=\"160\" >"+((crset.getString("orgcount").equals("0"))?"":crset.getString("orgcount")) + "</td>");           
					out.println(      "</tr>");
					counter++;                       
