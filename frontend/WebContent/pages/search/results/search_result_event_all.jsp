...
if(request.getParameter("f_year") != null && !request.getParameter("f_year").equals("")){
		...
		if(crset != null && crset.next()){
			...
			<!-- DISPLAY HEADERS AND TITLES   -->
			      <thead>
			      <tr>
			       <th width="30%" ><b><a href="#" onClick="reSortData('event_name')">Name</a></b></th>
			       <th width="40%" ><b><a href="#" onClick="reSortData('venue_name')">Venue</a></b></th>
			       <th width="15%" align='right' style="text-align:right" ><b><a href="#" onClick="reSortData('first_date')">First Date</a></b></th>      
			...
			do{
				...
				if(do_print){
					...
					out.println("      <tr>");                                               
					out.println("       <td " + bgcolour +  " valign=\"top\" width=\"30%\" ><a href=\"/pages/event/" + crset.getString("eventid") + "\" onmouseover=\"this.style.cursor='hand';\">" + crset.getString("event_name")+  "</a></td>");
					out.print("       <td " + bgcolour +  " valign=\"top\" width=\"40%\" >");
					...
					out.println("       <td " + bgcolour +  " valign=\"top\" align ='right' width=\"15%\" >");
					formatted_date = "";
			...
			<%  
				...
				out.println("      </tr>");
				out.println("      <tr id=\"refreshFooter\" width=\"100%\" class=\"search-bar b-90\" style=\"height:2.5em;\">");
