...
%>
  <form name="searchform" id="searchform" method="post" action ="results/" onsubmit="return checkFields();">
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    ...
    <table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
      ...
      <tr>
        <td align='right' class='general_heading_white'>Title</td>
        <td><input name = 'f_title' id ='f_title' type='text' size='60'       <%if(request.getParameter("f_title") != null) { out.print("value=\"" + request.getParameter("f_title") + "\"");}%> >&nbsp;</td>
      </tr>
      <tr>
        <td align='right' class='general_heading_white'>Creator</td>
        <td>
          <input name = 'f_creator' id ='f_creator' type='text' size='60'       <%if(request.getParameter("f_creator") != null) { out.print("value=\"" + request.getParameter("f_creator") + "\"");}%> >&nbsp;
        </td>
      </tr>
      <tr>
        <td align='right' class='general_heading_white'>Source</td>
        <td>
          <input name = 'f_source' id ='f_source' type='text' size='60'   <%if(request.getParameter("f_source") != null) { out.print("value=\"" + request.getParameter("f_source") + "\"");}%> >&nbsp;
        </td>
     </tr>
     <tr>
       <td align='right' class='general_heading_white'>Keywords</td>
       <td class='general_heading_white'>
         <input name = 'f_keywords' id ='f_keywords' type=text class='fsearchlarge' size='60'   <%if(request.getParameter("f_keywords") != null) { out.print("value=\"" + request.getParameter("f_keywords") + "\"");}%> >
       </td>
     </tr>
     ...
     <tr>
       <td align='right' class='general_heading_white'>Date</td>
       <td class='general_heading_white'>
    ...
    <tr><td>&nbsp;</td><td>&nbsp;</tr>
    <tr>
      <td align='right' valign='top' class='general_heading_white'>Type</td>
      <td>
     ...
     <tr>
       <td align='right' class='general_heading_white'>Collecting&nbsp;Institution</td>
       <td>
       ...
       <tr>
          <td align='right' class='general_heading_white'>Work</td>
          <td>
            <input id='f_work' name ='f_work' type='text' size='60' <%if(request.getParameter("f_work") != null) { out.print("value=\"" + request.getParameter("f_work") + "\"");}%> >&nbsp;</td>
        </tr>
        <tr>
          <td align='right' class='general_heading_white'>Event</td>
          <td>
            <input id='f_event' name ='f_event' type='text' size='60' <%if(request.getParameter("f_event") != null) { out.print("value=\"" + request.getParameter("f_event") + "\"");}%>>&nbsp;</td>
        </tr>
        <tr>
        <td align='right' class='general_heading_white'>Contributor</td>
        <td>
          <input id='f_contributor' name ='f_contributor' type='text' size='60' <%if(request.getParameter("f_contributor") != null) { out.print("value=\"" + request.getParameter("f_contributor") + "\"");}%>>&nbsp;</td>
        </tr>
        
        <tr>
        <td align='right' class='general_heading_white'>Venue</td>
        <td>
          <input id='f_venue' name ='f_venue' type='text' size='60' <%if(request.getParameter("f_venue") != null) { out.print("value=\"" + request.getParameter("f_venue") + "\"");}%>>&nbsp;</td>
        </tr>
        
        <tr>
          <td valign='top' align='right' class='general_heading_white'>Organisation</td>
          <td class='general_heading_white'>
            <input id='f_organisation' name ='f_organisation' type=text class='fsearchlarge' size='60' <%if(request.getParameter("f_organisation") != null) { out.print("value=\"" + request.getParameter("f_organisation") + "\"");}%>></td>
        </tr>
  ...
  <td>
    <select name='f_assoc_item' id='s'>
      ...
      <option value='ONLINE'>Online Resources</option>
        ...
        <td class='general_heading_white' align='right'>Sort results by</td>
          <td>
            <select name='f_sort_by' id='f_sort_by'>
              <option value='type'   <%if(request.getParameter("f_sort_by") != null && request.getParameter("f_sort_by").equals("type")) { out.print(" selected ");}%> >Type</option>
              ...
              <option value='source' <%if(request.getParameter("f_sort_by") != null && request.getParameter("f_sort_by").equals("source")) { out.print(" selected ");}%> >Source</option>
        ...
        <tr>
          <td></td>
          <td align='left'><input value='Search'type="submit" ><a class="helpIcon" target='_blank' href="/pages/static/help.html"></a></td>
        </tr>
        <tr>
          <td></td>
        </tr>       
  ...
  function isDate (day, month, year) {
    ...
    function checkFields(){
      ...
      if(form.f_keywords.value == "" && form.f_firstdate_yyyy.value == "" && form.f_collectingInstitution.value == ""
          ...
          && form.f_sub_types.selectedIndex == 0
