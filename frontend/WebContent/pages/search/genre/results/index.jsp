...
<table class="search-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <tr>
      ...
      <th width="20%" align="right" style="text-align:right" ><b><a href="#" onClick="reSortNumbers('num')">Events</a></b></th>
      <th width="20%" align="right" style="text-align:right" ><b><a href="#" onClick="reSortNumbers('total')">Resources</a></b></th>
    </tr>
    </thead>
    <%
