...
<%
  ...
  String keyword=m_db.plSqlSafeString(request.getParameter("f_keyword"));
...
m_db.connDatabase(constants.DB_ADMIN_USER_NAME, constants.DB_ADMIN_USER_PASSWORD);
  ...
  out.print("<div class=\"search-bar b-90\">"
...
<table class="search-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <tr>
      ...
      <th width="20%" align="right" style="text-align:right"><b><a href="#" onClick="reSortNumbers('count(distinct events.eventid)')">Events</a><b></th>
      <th width="20%" align="right" style="text-align:right"><b><a href="#" onClick="reSortNumbers('count(distinct itemcontentindlink.itemid)')">Resources</a><b></th>
    </tr>
    </thead>
    <div class='letters'>
    <%
