...
<form class="search-form" name="advancedSearchForm" id="advancedSearchForm" Method="POST" onsubmit="return checkFields();" action="results/" STYLE="height:100%">
<style>
...
<div class="scrollable footer-space" >
