...
<!--	<script type="text/javascript" src="//maps.google.com/maps/api/js?v=3.3&sensor=false"></script>-->
	<script src="https://maps.googleapis.com/maps/api/js?v=3.3&sensor=false&key=<%=appConstants.GOOGLE_KEY%>" type="text/javascript"></script>
	    		...
	    		<div class="accordion" id="mapLegendAdvancedControls">
					...
					<ul>
		 				<li class="map-bookmark-open clickable">Bookmark this map</li>
		  				...
		  				<li class="map-generate-embed clickable">Get embed code for this map</li>
					</ul>
	      			</div>
 	    		</div>
	  	</div>
...
<!--Generate Embed code dialog-->
<div id="map_embed_div" title="Generate Embed Cose" class="dialogs">
	<h3>Generate code to embed this map in your website </h3>
	<p>
	...
	<p>As of July 16, 2018, Google will be introducing new structuring for embedding Google Maps. If you would like to Embed this map, you will need to register with the Google Maps Platform and create an
	API Key. The API Key you retrieve will need to replace the text <b>YOUR_API_KEY</b> in the code below.</p>
	
	<p>More information on creating an API Key can be found <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">here</a></p>
	
	<textarea style="width:100%; height:200px" id="embed_code" readonly/></textarea>
