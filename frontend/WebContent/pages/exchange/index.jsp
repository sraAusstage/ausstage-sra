...
%>
  ...
  #footer { position: fixed !important; }
		...
		<!-- main content -->
	<div class="page b-172" style="height: Calc(100% - 120px);    overflow: auto;">
		...
		<p>
		 <strong>Note: </strong>Search results are limited to 100 records. If you do not see the results that you expected, please refine your search.
