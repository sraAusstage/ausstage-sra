...
<div class='record'>
						...
						String org_id               = db_ausstage_for_drill.plSqlSafeString(request.getParameter("id"));
						String location             = "";
						...
						<table class='record-table'>
							...
							<td class='record-value bold' style='padding-right:280px' > <%=organisation.getName()%>
							<%
...
//												}
					...
					//Exhibitions
						...
						if (!(organisation.getExhibitions()).isEmpty()) {
							
						%>
							<tr>
								<th class='record-label b-121'>Exhibitions</th>
								
								<td class='record-value' colspan='2'>
								
									<ul>
								<%Vector<Exhibition> exhibitions = organisation.getExhibitions();
