...
<table class="browse-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <thead>
    <tr>
      <th width="70%"><b> <a href="#" onClick="reSortData('name')"> Name  (<%=SearchCount.formatSearchCountWithCommas(l_rs.getString(1))%>)</a></b></th>
      <th width="30%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('counter')">Resources</a></b></th>
    </tr>
    </thead>
    <%
