...
<%
  ...
  //System.out.println(constants.DB_ADMIN_USER_NAME);
  Statement stmt    = m_db.m_conn.createStatement ();
      
  sqlString =	"SELECT COUNT(*) From `events` WHERE TRIM(leading 'a ' from TRIM(leading 'an ' from TRIM(leading 'the ' from LOWER(events.EVENT_NAME)))) "+switchLike;
...
<table class="browse-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <thead>
    <tr>
      <th width="30%" style="width:30%"><a href="#" onClick="reSortData('name')">Name (<%=SearchCount.formatSearchCountWithCommas(l_rs.getString(1))%>)</a></th>
      <th width="40%" align="left" style="width:40%"><a href="#" onClick="reSortData('vname')">Venue</a></th>
      <th width="15%" align="right" style="text-align:right; padding-right:20px; width:15px"><a href="#" onClick="reSortNumbers('dat')">First Date</a></th>
      <th width="15%" align="right" style="text-align:right; width:15%"><a href="#" onClick="reSortNumbers('total')">Resources</a></th>
    </tr>
    </thead>
    <tbody>
    <%
 ...
 <div  width="100%" class="browse-bar b-90" style="height:2.5em;">
