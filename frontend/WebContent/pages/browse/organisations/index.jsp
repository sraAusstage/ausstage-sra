...
<%
  ...
  if ((sortOrd == null) ||  (sortOrd.contains("ASC"))){
	  sortOrd = "ASC";	  //then set it to ASC (stripping any other possible injections)
  }
  else {  //if its not asc then it will be desc. This way we clean the value we read in and avoid any sql injections.
	  sortOrd = "DESC";
  }
  ...
  Statement stmt    = m_db.m_conn.createStatement ();
	...
	//should remove this and use the count from the actual query!
...
<table class="browse-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <tr>
      ...
      <th width="10%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('num')">Events</a></b></th>
      <th width="10%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('total')">Resources</a></b></th>
    </tr>
    </thead>
    <%
