...
<table class="browse-table">
  <form name="form_searchSort_report" method="post" action=".">
    ...
    <thead>
    <tr>
      <th width="25%"><b><a href="#" onClick="reSortData('name')">Name  (<%=SearchCount.formatSearchCountWithCommas(recordCount)%>)</a> </b></th>
      ...
      <th width="15%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('num')">Events</a><b></th>
      <th width="15%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('total')">Resources</a><b></th>
    </tr>
    </thead>
    <%
