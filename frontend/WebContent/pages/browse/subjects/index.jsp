...
<table class="browse-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <tr>
      ...
      <th width="20%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('count(distinct events.eventid)')">Events</a><b></th>
      <th width="20%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('count(distinct itemcontentindlink.itemid)')">Resources</a><b></th>
    </tr>
    </thead>
    <div class='letters'>
    <%
