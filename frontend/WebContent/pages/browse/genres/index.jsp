...
<%
  ...
  sqlString =	"SELECT COUNT(*) From `secgenreclass`";
...
<table class="browse-table">
  ...
  <%-- These are hidden inputs that will be populated by the reSortData() JavaScript function. --%>
    ...
    <tr>
      ...
      <th width="20%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('num')">Events</a></b></th>
      <th width="20%" style="text-align:right" align="right"><b><a href="#" onClick="reSortNumbers('total')">Resources</a></b></th>
    </tr>
    </thead>
    <%
        ...
        else
        {
          ...
          try {
            if (l_rs.getString(3) != null)
            {
                ...
                if (l_rs.getString(8) != null && !l_rs.getString(8).equals(""))                  
                  maxFirstDate = Integer.parseInt(l_rs.getString(8));
                  
                if (l_rs.getString(4) != null&& !l_rs.getString(4).equals(""))                 
                  maxLastDate = Integer.parseInt(l_rs.getString(4));
                  
                if ((l_rs.getString(3) != null && !l_rs.getString(3).equals(""))&&(maxFirstDate < maxLastDate))
                {
