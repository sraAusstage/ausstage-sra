...
function getCode(){
        ...
        var url = '/opencms/exchange/'+recordType+'?type='+type+'&id='+id+'&limit='+limit+'&sort='+sort+'&output=json&callback=?'
...
function initSearch(){
        ...
        var url = "/opencms/exchange/lookup?task=contentindicator";
        ...
        //populate the second genre dialog
        var url = "/opencms/exchange/lookup?task=secgenre";
        ...
        //populate the second genre dialog
        var url = "/opencms/exchange/lookup?task=ressubtype";
        ...
        $("#search_form").validate({
                ...
                submitHandler: function(form) {
                        var url = "/opencms/mapping2/search?task="+$('#task').val()+"&type=name&format=json&query="+encodeURIComponent($('#query').val());
