...
SearchClass.prototype.buildContributorResults = function(data) {
       ...
       //SR901 Brad W --
       // if(i == 25) {
        if(i == searchObj.DEFAULT_SEARCH_LIMIT){
                $("#contributor_results").append(searchObj.LIMIT_REACHED_MSG);
                $("#contributor_heading").empty().append("Contributors ("+searchObj.DEFAULT_SEARCH_LIMIT+"+)");
        } else {
...
SearchClass.prototype.buildOrganisationResults = function(data) {
       ...
       // if(i == 25) {
        if(i == searchObj.DEFAULT_SEARCH_LIMIT){
                ...
                $("#organisation_heading").empty().append("Organisations ("+searchObj.DEFAULT_SEARCH_LIMIT+"+)");
        } else {
...
SearchClass.prototype.buildVenueResults = function (data) {
       ...
       // if(i == 25) {
        if(i == searchObj.DEFAULT_SEARCH_LIMIT){
                ...
                $("#venue_heading").empty().append("Venues ("+searchObj.DEFAULT_SEARCH_LIMIT+"+)");
        } else {
...
SearchClass.prototype.buildEventResults = function (data) {
       ...
       // if(i == 25) {
        if(i == searchObj.DEFAULT_SEARCH_LIMIT){
                ...
                $("#event_heading").empty().append("Events ("+searchObj.DEFAULT_SEARCH_LIMIT+"+)");
        } else {
...
SearchClass.prototype.buildWorkResults = function(data) {
       ...
       // if(i == 25) {
        if(i == searchObj.DEFAULT_SEARCH_LIMIT){
                ...
                $("#work_heading").empty().append("Works ("+searchObj.DEFAULT_SEARCH_LIMIT+"+)");
        } else {
