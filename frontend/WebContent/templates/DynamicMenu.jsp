    ...
    while (navItem.hasNext())
    {
      ...
      if (nav != null) 
      {
        ...
        if (nav.isFolderLink()) 
        {
          ...
          if (link == null) {
            target = nav.getResourceName().substring("/system/modules/au.edu.flinders.ausstage.learn".length());
          } else {
            target = link.getResourceName().substring("/system/modules/au.edu.flinders.ausstage.learn".length());
          }
          ...
          {      
            ...
            out.write("<li> <a class='family_links_current" + spacer + "' href='" + nav.getResourceName().substring("/system/modules/au.edu.flinders.ausstage.learn".length()) + "' >" + navText + "</a></li>\n");
          }
        }
      }
    }
...
String startingFolder = "/system/modules/au.edu.flinders.ausstage.learn/pages/learn/";
