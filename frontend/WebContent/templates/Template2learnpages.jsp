  ...
  <div class="wrapper">
	<div class='header-wrapper'>
		...
		<div style="width:141px;">	
	      	...
	      	<div style="width:100%; display: flex; align-items: center; color: #7f7f7f;font-size: 23PX;font-family: sans-serif;">
			<span>The Australian Live Performance Database</span>
		</div>
		<%if (showSearch){%>
		<div class="width :200px; ">
	      		<div class="header-search">
				<form name="header-search-form" id="header-search-form" method="post" action="/pages/browse/"><!-- onSubmit="return updateHeader();"> -->
					<input lang="en" id="header-search-keywords" type="text" class="" style="width: 140px;" value=<% out.print("\""+keywords+"\""); %>>
