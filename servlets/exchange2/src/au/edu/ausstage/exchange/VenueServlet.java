...
public class VenueServlet extends HttpServlet {
	...
	public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// get the results
		if(type.equals("country") == true) {
			// get venue data based on country ids
			CountryData data = new CountryData(database, ids, output, limit, sort);
			results = data.getVenueData();
		}
		...
		if (request.getHeader("Referer") == null) {
			context.log("Task: venues QueryString: " + request.getQueryString() + " RemoteAddress: " + request.getRemoteAddr() + " Referer: " + request.getHeader("Referer"));
		} else {
			context.log("Task: venues QueryString: " + request.getQueryString() + " RemoteAddress: null Referer: " + request.getHeader("Referer"));
		}
	}
