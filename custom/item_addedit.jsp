...
<%
  ...
  out.println("<input type='hidden' name='f_from_item_add_edit_page' value='true'>");
  ...
  ****************************/
  ...
  out.println("<select name='f_item_type' id='f_item_type' size='1' class='line250' onchange=\"refreshChildCodeTypeList(this.value,'f_item_sub_type', 'ajaxLoadingImageResType');\"" + disabled + ">");
  ...
  out.println("<select name='f_item_sub_type' id='f_item_sub_type' size='1' class='line250'" + disabled + ">");
