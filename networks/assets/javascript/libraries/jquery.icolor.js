 ...
 *
 * Updated for the Aus-e-stage project by Brad Williams. 
 * Added option holdColor, default = true. If false it will not hold the last selected color in memory.
 */
;(function($) {
    // Private functions.
    var p = {};
	...
	p.M.prototype={
		...
		_initLayout:function(){
			...
			this.$colors.click(function(e){
				//edited by BW
				if(this.className=="hot" && _this.holdColor)return;
    ...
    $.fn.icolor.defaults = {
		...
		//edited by BW
		holdColor:true									/* whether to hold the selected color */
    };
	//public methods
